...
class CreateComponent extends Component
{
    ...
    public $offline_info;
    public $amount;
    public $confirmation_amount = 0;
    public $confirmation_commission = 0;
    public $confirmation_net = 0;
    ...
    public function confirm()
    {
        try {
            ...
            if (settings('commission')->commission_from === 'withdrawals') {
                ...
                $this->confirmation_amount     = convertToNumber($this->amount);
                $this->confirmation_commission = convertToNumber($commission_value);
                $this->confirmation_net        = $this->confirmation_amount - $this->confirmation_commission;

                $this->dispatch('open-modal', 'modal-confirm-withdrawal');
            } else {
    ...
    public function withdraw()
    {
        try {
            ...
            $this->dispatch('close-modal', 'modal-confirm-withdrawal');
