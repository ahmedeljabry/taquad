                ...
                <div class="shrink-0 w-full lg:w-56 rounded-t-md ltr:lg:rounded-l-md rtl:lg:rounded-r-md lg:ltr:rounded-tr-none lg:rtl:rounded-tl-none">
                    <div class="relative h-full">
                        <div class="flex grow flex-col items-center justify-center h-full px-4 pb-5 sm:px-5 pt-6">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($project->client->fullname): ?>
                                <h3 class="pt-3 text-sm font-bold text-zinc-900 dark:text-zinc-100 flex items-center">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($project->client->status === 'verified'): ?>
                                        <?php
                                            $uuid = uid();
                                        ?>
                ...
                <div class="flex w-full grow flex-col px-4 py-6 sm:px-5 justify-center">
                    ...
                    <div class="flex items-center justify-between">
                        <div class="mb-3 space-y-2 sm:space-y-0 sm:space-x-2 rtl:space-x-reverse flex flex-col sm:block w-full">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($project->status === 'active' && $project->awarded_bid && $project->awarded_bid->status === 'active' && !$project->awarded_bid->is_freelancer_accepted && $project->awarded_freelancer_id == auth()->id()): ?>
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($project->has_confirmed_milestone): ?>
                    ...
                    <div class="mt-1 flex justify-end">
                        <div class="flex justify-between py-3 space-x-4 rtl:space-x-reverse">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if( in_array($project->status, ['active', 'completed', 'under_development', 'pending_final_review', 'incomplete', 'closed']) && $project->awarded_bid && $project->awarded_bid->status === 'active' && $project->awarded_bid->is_freelancer_accepted && $project->awarded_freelancer_id == auth()->id() ): ?>
                                <div>
                     ...
                     <?php $__env->slot('content', null, []); ?> 
                        ...
                        <div class="flex justify-end">
                            ...
                            <div class="flex items-center text-sm font-normal text-gray-500 bg-gray-100 dark:bg-zinc-700 dark:text-zinc-400 px-3 py-2 rounded-md">
                                ...
                                <div>
                                    <!--[if BLOCK]><![endif]--><?php if($project->awarded_bid->days === 1): ?>
...
</div><?php /**PATH C:\xampp\htdocs\taquad\resources\views/livewire/main/seller/projects/projects.blade.php ENDPATH**/ ?>