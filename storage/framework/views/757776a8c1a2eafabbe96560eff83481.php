                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-y-6 gap-x-3 h-full">
                        ...
                        <div>
                            <div class="flex flex-col h-full justify-center items-center text-center space-y-3 dark:bg-zinc-800 dark:border-transparent py-4 px-2 border rounded-lg bg-slate-50 border-slate-200 shadow-sm-light dark:shadow-none">
                                ...
                                <div class="text-sm font-semibold tracking-wide dark:text-white text-zinc-700">
                                    <!--[if BLOCK]><![endif]--><?php if($expected_delivery_date): ?>
                        ...
                        <div>
                            <div class="flex flex-col h-full justify-center items-center text-center space-y-3 dark:bg-zinc-800 dark:border-transparent py-4 px-2 border rounded-lg bg-slate-50 border-slate-200 shadow-sm-light dark:shadow-none">
                                ...
                                <div class="text-sm font-semibold tracking-wide dark:text-white text-zinc-700">
                                    <?php echo e(money($payments_in_progress, settings('currency')->code, true), false); ?>
                        ...
                        <div>
                            <div class="flex flex-col h-full justify-center items-center text-center space-y-3 dark:bg-zinc-800 dark:border-transparent py-4 px-2 border rounded-lg bg-slate-50 border-slate-200 shadow-sm-light dark:shadow-none">
                                ...
                                <div class="text-sm font-semibold tracking-wide dark:text-white text-zinc-700">
                                    <?php echo e(money($paid_amount, settings('currency')->code, true), false); ?>
                ...
                <div class="w-full">
                    ...
                    <div class="flex justify-end items-center mt-12">
                        <div class="flex items-center space-x-3 rtl:space-x-reverse">
                            ...
                            <!--[if BLOCK]><![endif]--><?php if(in_array($project->status, ['active', 'under_development', 'pending_final_review'])): ?>
                    ...
                    <div class="mt-8 overflow-x-auto overflow-y-hidden scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 dark:scrollbar-thumb-zinc-800 dark:scrollbar-track-zinc-600">
                        <table class="w-full text-left border-spacing-y-[10px] border-separate -mt-2">
                            ...
                            <thead>
                                <!--[if BLOCK]><![endif]--><?php $__empty_1 = true; $__currentLoopData = $payments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr class="intro-x shadow-sm bg-white dark:bg-zinc-800 rounded-md h-16" wire:key="employer-dashboard-project-milestones-<?php echo e($p->uid, false); ?>">
                                        ...
                                        <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                            <!--[if BLOCK]><![endif]--><?php switch($p->status):
                                        ...
                                        <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                            <div class="text-gray-700 dark:text-gray-100 text-sm font-medium">
                                                <?php echo e(money(convertToNumber($p->amount), settings('currency')->code, true), false); ?>
                                        ...
                                        <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                            <div class="text-gray-700 dark:text-gray-100 text-sm font-medium">
                                                <?php echo e(money(convertToNumber($p->amount) + convertToNumber($p->employer_commission), settings('currency')->code, true), false); ?>
                                        ...
                                        <td class="px-5 py-3 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-center">
                                            ...
                                            <button wire:click="details('<?php echo e($p->uid, false); ?>')" type="button" aria-label="<?php echo e(__('messages.t_details'), false); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 text-sm rounded border-gray-300 bg-white text-gray-600 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none transition-all duration-200 dark:bg-zinc-700 dark:border-transparent dark:text-zinc-200 dark:hover:bg-zinc-600" data-tooltip-target="tooltip-actions-details-<?php echo e($p->uid, false); ?>">
...
<?php endif; ?>
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if($p->status === 'request'): ?>
                                                    <button wire:click="confirmPay('<?php echo e($p->uid, false); ?>')" type="button" aria-label="<?php echo e(__('messages.t_deposit_funds'), false); ?>" class="inline-flex justify-center items-center border font-semibold focus:outline-none w-8 h-8 text-sm rounded border-gray-300 bg-white text-gray-600 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none transition-all duration-200 dark:bg-zinc-700 dark:border-transparent dark:text-zinc-200 dark:hover:bg-zinc-600" data-tooltip-target="tooltip-actions-pay-<?php echo e($p->uid, false); ?>">
...
<?php endif; ?>
                                                ...
                                                <!--[if BLOCK]><![endif]--><?php if($p->status === 'funded'): ?>
                                ...
                                <tfoot>
                                    <tr class="bg-slate-200 dark:bg-zinc-600 intro-x rounded-md h-16">
                                        ...
                                        <td class="text-center py-3 px-5 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-sm font-bold text-slate-600 dark:text-zinc-300">
                                            <?php echo e(money( convertToNumber($paid_amount) + convertToNumber($payments_in_progress), settings('currency')->code, true ), false); ?>

                                        </td>
                                        <td class="text-center py-3 px-5 first:ltr:rounded-l-md last:ltr:rounded-r-md first:rtl:rounded-r-md last:rtl:rounded-l-md text-sm font-bold text-slate-600 dark:text-zinc-300">
                                            <?php echo e(money( (convertToNumber($paid_amount) + convertToNumber($payments_in_progress)) + ((convertToNumber(settings('projects')->commission_from_publisher) / 100) * (convertToNumber($paid_amount) + convertToNumber($payments_in_progress))), settings('currency')->code, true ), false); ?>
                        ...
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                            ...
                            <div class="space-y-0.5">
                                ...
                                <div class="flex items-center">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($project->awarded_bid->user->fullname): ?>
                                ...
                                <div class="flex items-center space-x-3 rtl:space-x-reverse text-[13px] dark:text-zinc-400">
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($project->awarded_bid->user->country): ?>
                                    ...
                                    <!--[if BLOCK]><![endif]--><?php if($project->awarded_bid->user->status === 'verified'): ?>
                                        <div class="mx-2 my-0.5 text-gray-300 dark:text-zinc-400">|</div>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-milestone-confirm','target' => 'modal-milestone-confirm-trigger','uid' => 'modal_milestone_confirm','placement' => 'center-center','size' => 'max-w-md']); ?>
        <?php
        ...
        ?>
         ...
         <?php $__env->slot('title', null, []); ?> 
            <div class="flex items-center gap-3">
                <span class="<?php echo e($confirmIconWrapper, false); ?>">
                    <i class="<?php echo e($confirmIcon ?: 'ph-duotone ph-question text-xl', false); ?> <?php echo e($confirmIconClasses, false); ?>"></i>
                </span>
                <span class="text-sm font-semibold text-slate-700 dark:text-zinc-100"><?php echo $confirmTitle; ?></span>
            </div>
         <?php $__env->endSlot(); ?>

         <?php $__env->slot('content', null, []); ?> 
            <div class="space-y-4 text-sm leading-6 text-slate-600 dark:text-zinc-300">
                <?php echo $confirmDescription; ?>
         ...
         <?php $__env->slot('footer', null, []); ?> 
            <div class="flex w-full justify-between gap-2">
                ...
                <button type="button"
                        ...
                        <?php if(empty($confirmMethod)): echo 'disabled'; endif; ?>
                        class="<?php echo e($confirmClass, false); ?>">
                    <?php echo e($confirmLabel, false); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'modal-milestone-details','target' => 'modal-milestone-details-trigger','uid' => 'modal_milestone_details','placement' => 'center-center','size' => 'max-w-lg']); ?>
        <?php
         ...
         <?php $__env->slot('title', null, []); ?> 
            <div class="flex items-center gap-3">
                ...
                <span class="text-sm font-semibold text-slate-700 dark:text-zinc-100">
                    <?php echo e(data_get($detailData, 'title', __('messages.t_milestone_payment_details')), false); ?>
            ...
            <div class="space-y-6 text-sm leading-6 text-slate-600 dark:text-zinc-300">
                <div class="grid gap-3">
                    <div class="flex items-center justify-between rounded border border-slate-100 bg-slate-50 px-4 py-3 dark:border-zinc-600 dark:bg-zinc-800/60">
                        <span class="text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-zinc-400"><?php echo app('translator')->get('messages.t_status'); ?></span>
                        <span class="inline-flex items-center rounded-full px-2 py-0.5 text-xs font-semibold <?php echo e($statusClasses, false); ?>">
                            <?php echo e($detailStatus ?? '—', false); ?>
                    ...
                    <div class="grid gap-2 rounded border border-slate-100 bg-white px-4 py-3 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
                        <div class="flex items-center justify-between">
                            <span class="text-xs font-semibold uppercase tracking-wide text-slate-500 dark:text-zinc-400"><?php echo app('translator')->get('messages.t_amount'); ?></span>
                            <span class="font-semibold text-slate-800 dark:text-zinc-100"><?php echo e(data_get($detailData, 'amount', '—'), false); ?></span>
                        </div>
                        <div class="flex items-center justify-between text-xs text-slate-500 dark:text-zinc-400">
                            <span><?php echo app('translator')->get('messages.t_milestone_employer_fee_name'); ?></span>
                            <span class="font-medium text-slate-600 dark:text-zinc-200"><?php echo e(data_get($detailData, 'employer_fee', '—'), false); ?></span>
                        </div>
                        <div class="flex items-center justify-between text-xs text-slate-500 dark:text-zinc-400">
                            <span><?php echo app('translator')->get('messages.t_milestone_freelancer_fee_name'); ?></span>
                            <span class="font-medium text-slate-600 dark:text-zinc-200"><?php echo e(data_get($detailData, 'freelancer_fee', '—'), false); ?></span>
                        </div>
                        <div class="flex items-center justify-between border-t border-dashed border-slate-200 pt-2 text-xs font-semibold uppercase tracking-wide text-slate-500 dark:border-zinc-700 dark:text-zinc-300">
                            <span><?php echo app('translator')->get('messages.t_total'); ?></span>
                            <span class="text-sm text-slate-800 dark:text-zinc-100"><?php echo e(data_get($detailData, 'total', '—'), false); ?></span>
                        </div>
                    </div>
                    <div class="grid gap-2 rounded border border-slate-100 bg-white px-4 py-3 text-xs text-slate-500 shadow-sm dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-300">
                        <div class="flex items-center justify-between">
                            <span><?php echo app('translator')->get('messages.t_id'); ?></span>
                            <span class="font-semibold text-slate-700 dark:text-zinc-100"><?php echo e(data_get($detailData, 'uid', '—'), false); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span><?php echo app('translator')->get('messages.t_created_at'); ?></span>
                            <span class="font-semibold text-slate-700 dark:text-zinc-100"><?php echo e(data_get($detailData, 'created_at', '—'), false); ?></span>
                        </div>
                        <div class="flex items-center justify-between">
                            <span><?php echo app('translator')->get('messages.t_updated_at'); ?></span>
                            <span class="font-semibold text-slate-700 dark:text-zinc-100"><?php echo e(data_get($detailData, 'updated_at', '—'), false); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="rounded-lg border border-slate-100 bg-white px-4 py-3 shadow-sm dark:border-zinc-700 dark:bg-zinc-800">
                    ...
                    <div class="prose prose-sm max-w-none text-slate-600 dark:prose-invert dark:text-zinc-200">
                        <?php echo data_get($detailData, 'description') ?: '<span class="text-slate-400 dark:text-zinc-500">'.__('messages.t_no_data_to_show_now').'</span>'; ?>
...
<?php /**PATH C:\xampp\htdocs\taquad\resources\views/livewire/main/account/projects/options/milestones.blade.php ENDPATH**/ ?>