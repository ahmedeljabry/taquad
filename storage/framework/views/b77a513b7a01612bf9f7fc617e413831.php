	...
	<nav class="hidden justify-between px-4 py-3 text-gray-700 rounded-lg sm:flex sm:px-5 bg-white dark:bg-zinc-700/40 dark:border-zinc-700 shadow" aria-label="Breadcrumb">
		...
		<ol class="inline-flex items-center mb-3 space-x-1 md:space-x-3 rtl:space-x-reverse sm:mb-0">
			...
			<li aria-current="page">
				<div class="flex items-center">
					<svg aria-hidden="true" class="w-5 h-5 text-gray-400 rtl:rotate-180" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
		...
		<div class="relative">
			<button x-on:click="is_actions_menu = !is_actions_menu" class="inline-flex items-center px-3 py-2 text-sm font-normal text-center text-gray-600 bg-gray-200 rounded hover:bg-gray-300 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-zinc-700 dark:hover:bg-zinc-600 dark:text-zinc-300 dark:focus:ring-zinc-700">
				<svg class="w-4 h-4 ltr:mr-2 rtl:ml-2" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
					<path d="M7 3a1 1 0 000 2h6a1 1 0 100-2H7zM4 7a1 1 0 011-1h10a1 1 0 110 2H5a1 1 0 01-1-1zM2 11a2 2 0 012-2h12a2 2 0 012 2v4a2 2 0 01-2 2H4a2 2 0 01-2-2v-4z"></path>
				</svg>
				<?php echo app('translator')->get('messages.t_actions'); ?>
				<svg class="w-4 h-4 ltr:ml-1 rtl:mr-1" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
							...
							<?php if (auth()->id() != $project->user_id): ?>
								<li>
									<button type="button" id="modal-report-project-button" class="w-full flex items-center space-x-3 rtl:space-x-reverse px-4 py-2 hover:bg-gray-100 dark:hover:bg-zinc-600 dark:hover:text-white focus:outline-none focus:ring-transparent">
										<svg class="w-5 h-5 text-gray-500 dark:text-zinc-300" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
			...
			<div class="space-y-10 lg:col-start-1 lg:col-span-2">
					...
					<div class="bg-white dark:bg-zinc-800 shadow-sm rounded-lg border dark:border-transparent">
						...
						<div class="border-t border-gray-100 dark:border-zinc-600 px-4 py-5 sm:px-6 pb-8">
							...
							<div>
								...
								<?php $__currentLoopData = $project->skills;
								...
								<div class="rounded-md bg-yellow-50 dark:bg-zinc-700 p-4 mt-10">
									<div class="flex">
										<div class="flex-shrink-0">
											<svg class="h-5 w-5 text-yellow-400 dark:text-zinc-400" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
				...
				<section class="relative">
							...
							<div class="flex items-center">
								...
								<div x-data="{ open: false }" class="relative inline-block">
									...
									<button type="button" aria-haspopup="true" x-bind:aria-expanded="open" x-on:click="open = true" aria-expanded="true" class="inline-flex justify-center items-center space-x-2 rtl:space-x-reverse rounded border font-semibold focus:outline-none px-3 py-2 leading-5 text-sm border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-transparent dark:text-zinc-300 dark:hover:bg-zinc-600">
										<svg class="inline-block w-5 h-5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
											<path d="M7 11h10v2H7zM4 7h16v2H4zm6 8h4v2h-4z"></path>
										</svg>
										<span><?php echo app('translator')->get('messages.t_filter'); ?></span>
										<svg class="inline-block w-4 h-4" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
					...
					<?php if ($project->status === 'closed'): ?>
						<div class="bg-white shadow-sm rounded-lg px-6 sm:px-12 py-6 sm:py-12 mt-8 grid text-center items-center justify-center">
							<div class="w-52 h-52 bg-gray-50 rounded-full flex items-center justify-center">
								<svg class="w-40 h-40 text-zinc-400" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" data-name="Layer 1" viewBox="0 0 807.45276 499.98424">
									<path id="ad903c08-5677-4dbe-a9c7-05a0eb46801f-1657" data-name="Path 461" d="M252.30849,663.16553a22.728,22.728,0,0,0,21.947-3.866c7.687-6.452,10.1-17.081,12.058-26.924l5.8-29.112-12.143,8.362c-8.733,6.013-17.662,12.219-23.709,20.929s-8.686,20.6-3.828,30.024" transform="translate(-196.27362 -200.00788)" fill="#e6e6e6" />
									<path id="a94887ac-0642-4b28-b311-c351a0f7f12b-1658" data-name="Path 462" d="M253.34651,698.41151c-1.229-8.953-2.493-18.02-1.631-27.069.766-8.036,3.217-15.885,8.209-22.321a37.13141,37.13141,0,0,1,9.527-8.633c.953-.6,1.829.909.881,1.507a35.29989,35.29989,0,0,0-13.963,16.847c-3.04,7.732-3.528,16.161-3,24.374.317,4.967.988,9.9,1.665,14.83a.9.9,0,0,1-.61,1.074.878.878,0,0,1-1.074-.61Z" transform="translate(-196.27362 -200.00788)" fill="#f2f2f2" />
									<path d="M496.87431,505.52556a6.9408,6.9408,0,0,1-2.85071.67077l-91.60708,2.51425a14.3796,14.3796,0,0,1-.62506-28.75241l91.60729-2.51381a7.00744,7.00744,0,0,1,7.15064,6.8456l.32069,14.75586a7.01658,7.01658,0,0,1-3.99577,6.47974Z" transform="translate(-196.27362 -200.00788)" fill="currentColor" />
									<path d="M379.332,698.59808H364.57245a7.00786,7.00786,0,0,1-7-7V568.58392a7.00785,7.00785,0,0,1,7-7H379.332a7.00786,7.00786,0,0,1,7,7V691.59808A7.00787,7.00787,0,0,1,379.332,698.59808Z" transform="translate(-196.27362 -200.00788)" fill="currentColor" />
									<path d="M418.52435,698.59808H403.76459a7.00786,7.00786,0,0,1-7-7V568.58392a7.00785,7.00785,0,0,1,7-7h14.75976a7.00786,7.00786,0,0,1,7,7V691.59808A7.00787,7.00787,0,0,1,418.52435,698.59808Z" transform="translate(-196.27362 -200.00788)" fill="currentColor" />
									<circle cx="196.71571" cy="182.69717" r="51" fill="currentColor" />
									<path d="M410.30072,605.205H373.61127a43.27708,43.27708,0,0,1-37.56043-65.05664l51.30933-88.87012a6.5,6.5,0,0,1,11.2583,0l50.27612,87.08057A44.56442,44.56442,0,0,1,410.30072,605.205Z" transform="translate(-196.27362 -200.00788)" fill="#2f2e41" />
									<path d="M405.02686,404.114c3.30591-.0918,7.42029-.20655,10.59-2.522a8.13274,8.13274,0,0,0,3.20007-6.07275,5.47084,5.47084,0,0,0-1.86035-4.49315c-1.65552-1.39894-4.073-1.72706-6.67823-.96144l2.69922-19.72558-1.98144-.27149-3.17322,23.18994,1.65466-.75928c1.91834-.87988,4.55164-1.32763,6.188.05518a3.51514,3.51514,0,0,1,1.15271,2.89551,6.14686,6.14686,0,0,1-2.38122,4.52783c-2.46668,1.80176-5.74622,2.03418-9.46582,2.13818Z" transform="translate(-196.27362 -200.00788)" fill="#2f2e41" />
									...
									<path d="M380.99359,593.79839a6.94088,6.94088,0,0,1-.67077-2.85072l-2.51425-91.60708a14.3796,14.3796,0,0,1,28.75241-.62506l2.51381,91.60729a7.00744,7.00744,0,0,1-6.8456,7.15064l-14.75586.32069a7.01655,7.01655,0,0,1-6.47974-3.99576Z" transform="translate(-196.27362 -200.00788)" fill="currentColor" />
									...
									<rect id="fc777aff-63b1-4720-84dc-e3a9c20790b9" data-name="ab2e16f2-9798-47da-b25d-769524f3c86f" x="484.20919" y="242.03206" width="437.1948" height="207.45652" transform="translate(-238.48792 -95.97299) rotate(-8.21995)" fill="#f1f1f1" />
									<rect id="ecffa418-b240-4504-be04-512edea7ccda" data-name="bf81c03f-68cf-4889-8697-1102f95f97bb" x="496.79745" y="259.81556" width="412.19197" height="173.08746" transform="translate(-238.57266 -95.95442) rotate(-8.21995)" fill="#fff" />
									<rect id="b49ce3f1-9d75-4481-986b-3b6beb000c79" data-name="f065dccc-d150-492a-a09f-a7f3f89523f0" x="468.80837" y="231.16611" width="437.19481" height="18.57334" transform="translate(-223.58995 -99.25677) rotate(-8.21995)" fill="#e5e5e5" />
									...
									<rect id="a6067cfc-0392-4d68-afe4-e34d11a8f0ac" data-name="ab2e16f2-9798-47da-b25d-769524f3c86f" x="370.25796" y="100.18309" width="437.1948" height="207.45652" fill="#e6e6e6" />
									<rect id="ecd65817-7467-4dbd-a435-c0f1d9841c98" data-name="bf81c03f-68cf-4889-8697-1102f95f97bb" x="382.75969" y="117.97286" width="412.19197" height="173.08746" fill="#fff" />
									<rect id="eea6c39d-8a45-4eb1-bab9-6120f465de14" data-name="f065dccc-d150-492a-a09f-a7f3f89523f0" x="370.07154" y="88.19711" width="437.19481" height="18.57334" fill="#cbcbcb" />
									...
									<path d="M699.66075,388.1056a37.91872,37.91872,0,0,1-55.87819,33.382l-.00736-.00737a37.907,37.907,0,1,1,55.88555-33.37461Z" transform="translate(-196.27362 -200.00788)" fill="#e6e6e6" />
									...
									<path d="M547.86351,482.19293c-17.96014,0-32.5719-15.52155-32.5719-34.60067,0-19.07858,14.61176-34.60014,32.5719-34.60014s32.5719,15.52156,32.5719,34.60014C580.43541,466.67138,565.82365,482.19293,547.86351,482.19293Zm0-60.4582c-13.13954,0-23.82929,11.59955-23.82929,25.85753s10.68975,25.85806,23.82929,25.85806,23.82928-11.60008,23.82928-25.85806S561.00305,421.73473,547.86351,421.73473Z" transform="translate(-196.27362 -200.00788)" fill="currentColor" />
									<path d="M578.70786,542.49212h-61.6887a20.54138,20.54138,0,0,1-20.51852-20.51826V461.46391a14.06356,14.06356,0,0,1,14.04747-14.04774h74.6308a14.06356,14.06356,0,0,1,14.04747,14.04774v60.50995A20.54138,20.54138,0,0,1,578.70786,542.49212Z" transform="translate(-196.27362 -200.00788)" fill="#3f3d56" />
									<path d="M559.88461,481.84022a12.0211,12.0211,0,1,0-17.48524,10.69829v18.808h10.92827v-18.808A12.01088,12.01088,0,0,0,559.88461,481.84022Z" transform="translate(-196.27362 -200.00788)" fill="#fff" />
					...
					<?php else: ?>
						...
						<?php $__currentLoopData = $bids;
						$__env->addLoop($__currentLoopData);
						foreach ($__currentLoopData as $bid): $__env->incrementLoopIndices();
							$loop = $__env->getLastLoop(); ?>
					...
					<div class="grid grid-cols-12 md:gap-x-6 gap-y-6 py-2">
						...
						<div class="col-span-12 md:col-span-6">
							...
							<label for="bid-amount-paid-input" class="text-gray-900 mb-2 text-[13px] font-bold dark:text-white flex items-center space-x-2 rtl:space-x-reverse">
								...
								<svg data-tooltip-target="bid-paid-to-you-tooltip" class="cursor-pointer w-4 h-4 text-gray-400" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
						...
						<div class="col-span-12">
							...
							<div class="relative w-full">
								...
								<div class="absolute inset-y-0 ltr:right-0 rtl:left-0 flex items-center ltr:pr-3 rtl:pl-3 font-bold text-xs tracking-widest dark:text-gray-300 uppercase">
									<svg class="w-5 h-5 text-gray-500" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
				...
				<?php if (settings('projects')->is_premium_bidding && $bid_current_step === 2): ?>
					<fieldset>
						...
						<div class="space-y-2 divide-y divide-gray-200 dark:divide-zinc-700 w-full">
							<?php $__currentLoopData = $plans;
							$__env->addLoop($__currentLoopData);
							foreach ($__currentLoopData as $plan): $__env->incrementLoopIndices();
								$loop = $__env->getLastLoop(); ?>
				...
				<ul class="flex items-center justify-center space-x-3 rtl:space-x-reverse">
					...
					<li>
						<a href="https://www.facebook.com/share.php?u=<?php echo e(url()->current(), false); ?>&t=<?php echo e($project->title, false); ?>" target="_blank" class="w-12 h-12 flex items-center justify-center rounded-xl bg-[#3b5998]" data-tooltip-target="share-project-btn-facebook">
							<svg class="w-5 h-5 text-white" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="currentColor">
