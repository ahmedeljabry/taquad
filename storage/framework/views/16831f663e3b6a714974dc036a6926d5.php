            ...
            <div class="w-full">
                <div class="flow-root">
                    <ul role="list" class="-mb-9">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $recent_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recent_user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li wire:key="recent-users-<?php echo e($recent_user->id, false); ?>">
                                <div class="relative pb-9">
                                    ...
                                    <div class="relative flex space-x-3 rtl:space-x-reverse">
                                        ...
                                        <div>
                                            <!--[if BLOCK]><![endif]--><?php if($recent_user->avatar): ?>
                                        ...
                                        <div class="flex min-w-0 flex-1 justify-between items-center space-x-4 rtl:space-x-reverse">
                                            ...
                                            <!--[if BLOCK]><![endif]--><?php if($recent_user->status === 'pending'): ?>
                ...
                <div class="w-full">
                    <div class="flow-root">
                        <ul role="list" class="-my-5 divide-y divide-gray-100 dark:divide-zinc-700">
                            <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $tracker_referers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tracker_referer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\taquad\resources\views/livewire/admin/home/home.blade.php ENDPATH**/ ?>