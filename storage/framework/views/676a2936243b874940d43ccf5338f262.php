                    ...
                    <div class="flex items-center text-sm font-normal text-gray-500 dark:text-zinc-300 gap-x-2">
                        ...
                        <div>
                            ...
                            <?php if(settings('general')->header_announce_link): ?>
                                <a href="<?php echo e(settings('general')->header_announce_link, false); ?>" target="_blank"
                ...
                <div class="inline-flex items-center min-w-fit">
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(current_theme() == 'dark' && settings('general')->logo_dark): ?>
                        <a href="<?php echo e(url('/'), false); ?>" class="block sm:ltr:mr-6 sm:rtl:ml-6">
                            <img width="150" height="<?php echo e($logo_height, false); ?>" src="<?php echo e($logo_dark, false); ?>" alt="<?php echo e($site_title, false); ?>"
                                style="height:<?php echo e($logo_height, false); ?>px;width:auto" data-primary-logo="<?php echo e($logo_dark, false); ?>"
                                data-transparent-logo="<?php echo e($logo_transparent, false); ?>" id="primary-logo-img">
                        </a>
                    <?php else: ?>
                        <a href="<?php echo e(url('/'), false); ?>" class="block sm:ltr:mr-6 sm:rtl:ml-6">
                            <img width="150" height="<?php echo e($logo_height, false); ?>" src="<?php echo e(src(settings('general')->logo), false); ?>"
                                alt="<?php echo e($site_title, false); ?>" style="height:<?php echo e($logo_height, false); ?>px;width:auto"
                                data-primary-logo="<?php echo e($logo, false); ?>" data-transparent-logo="<?php echo e($logo_transparent, false); ?>"
                                id="primary-logo-img">
                        </a>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->

                    
                    <div class="main-search-box hidden <?php echo e(request()->is('/') && auth()->guest() ? 'hidden' : 'lg:block', false); ?>"
                        x-data="{ open: false }">
                        ...
                        <div class="flex items-center w-full py-1.5 px-6 mx-4 rounded-full border border-slate-200 bg-white/90 shadow-[0_12px_30px_-18px_rgba(15,23,42,0.45)] transition focus-within:border-primary-400 focus-within:shadow-[0_15px_35px_-18px_rgba(59,130,246,0.55)] dark:border-zinc-700 dark:bg-zinc-900/70"
                            ...
                            <input wire:model.live.debounce.500ms="q" wire:keydown.enter="enter" x-ref="search"
                                ...
                                placeholder="<?php echo e(__('messages.t_what_service_are_u_looking_for_today'), false); ?>"
                                ...
                                <?php if(count($sellers) || count($tags)): ?>
                                    <ul class="max-h-80 scroll-py-10 scroll-pb-2 space-y-4 overflow-y-auto p-4 pb-2"
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($sellers && count($sellers)): ?>
                                            <li>
                                                <h2 class="text-xs font-semibold text-gray-900 dark:text-white">
                                                    <?php echo e(__('messages.t_sellers'), false); ?></h2>
                                                    ...
                                                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <li class="group flex cursor-default select-none items-center px-4 py-2">
                                                            <a href="<?php echo e(url('profile', $seller->username), false); ?>" class="flex items-center">
                                                                ...
                                                                <span
                                                                    class="ltr:ml-3 rtl:mr-3 flex-auto truncate"><?php echo e($seller->username, false); ?></span>
                                                            </a>
                                                        </li>
                                        ...
                                        <!--[if BLOCK]><![endif]--><?php if($tags && count($tags)): ?>
                                            <li>
                                                <h2 class="text-xs font-semibold text-gray-900 dark:text-white">
                                                    <?php echo e(__('messages.t_tags'), false); ?></h2>
                                                <ul class="-mx-4 mt-2 text-sm text-gray-700 dark:text-gray-400">
                                ...
                                <?php if(count($sellers) === 0 && count($tags) === 0 && $q): ?>
                                    <div class="py-14 px-6 text-center text-sm sm:px-14">
                                        ...
                                        <p class="mt-4 font-semibold text-gray-900 dark:text-white">
                                            <?php echo e(__('messages.no_results_found'), false); ?></p>
...
?>
                    ...
                    <!--[if BLOCK]><![endif]--><?php if(auth()->guard()->check()): ?>
                        ...
                        <button x-on:click="notifications_menu = true" type="button"
                            ...
                            aria-label="<?php echo app('translator')->get('messages.t_notifications'); ?>">
                            <span
                            ...
                            <!--[if BLOCK]><![endif]--><?php if($unreadCount > 0): ?>
                                <span
                                    ...
                                    <?php echo e($unreadCount > 9 ? '9+' : $unreadCount, false); ?>
...
[$__name, $__params] = $__split('main.includes.conversations-dropdown');

$__html = app('livewire')->mount($__name, $__params, 'lw-1768782321-1', $__slots ?? [], get_defined_vars());
                            ...
                            <div class="relative group">
                                ...
                                <button
                                    ...
                                    <?php if(auth()->user()->avatar): ?>
                                        <img class="object-cover w-8 h-8 rounded-full" src="<?php echo e(src(auth()->user()->avatar), false); ?>"
                                    ...
                                    <span
                                        class="dark:text-zinc-300 dark:hover:text-zinc-100"><?php echo e(auth()->user()->username, false); ?></span>
                                            ...
                                            <div class="divide-y divide-slate-100 dark:divide-zinc-700">
                                                ...
                                                <div class="py-1.5 px-3.5">
                                                    ...
                                                    <a href="<?php echo e(url('account/password'), false); ?>"
                                                        ...
                                                        <span
                                                            class="font-semibold text-xs text-gray-700 dark:text-gray-100 hover:text-primary-600 dark:hover:text-primary-500"><?php echo e(__('messages.t_update_password'), false); ?></span>
                                                    </a>
                                                ...
                                                <div class="py-1.5 px-3.5">
                                                    ...
                                                    <a href="<?php echo e(url('account/deposit'), false); ?>"
                                                        ...
                                                        <span
                                                            class="font-semibold text-xs text-gray-700 dark:text-gray-100 hover:text-primary-600 dark:hover:text-primary-500"><?php echo e(__('messages.t_deposit'), false); ?></span>
                                                    </a>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-1768782321-2', $__slots ?? [], get_defined_vars());
