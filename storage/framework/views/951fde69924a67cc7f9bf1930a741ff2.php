    ...
    <div class="w-full sm:mx-auto sm:max-w-2xl">
            ...
            <div class="bg-white dark:bg-zinc-800 justify-center pb-4 pt-5 px-4 rounded-md shadow-sm sm:align-middle sm:max-w-sm sm:p-6 sm:w-full mx-auto">
                <div>
                    <div class="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-green-100 dark:bg-zinc-700">
                        <svg class="h-6 w-6 text-green-600 dark:text-zinc-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
        ...
        <?php else: ?>
                ...
                <div class="w-full new-service-container">
                    <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                        ...
                        <div class="col-span-12">
                            <?php if (isset($component)) {
                                $__componentOriginal39e33f0763bff2831da94a32df9d0d40 = $component;
                            } ?>
                            <?php if (isset($attributes)) {
                                $__attributesOriginal39e33f0763bff2831da94a32df9d0d40 = $attributes;
                            } ?>
                        ...
                        <div class="col-span-12" wire:key="create-service-categories">
                            <?php if (isset($component)) {
                                $__componentOriginaldb6747d79aee05aaab45bb3a98f6c6bc = $component;
                            } ?>
                            <?php if (isset($attributes)) {
                                $__attributesOriginaldb6747d79aee05aaab45bb3a98f6c6bc = $attributes;
                            } ?>
                        ...
                        <div class="col-span-12" wire:key="create-service-subcategories">
                            ...
                            <?php if ($component->shouldRender()): ?>
                                ...
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $subcategory): $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-span-12" wire:key="create-service-childcategories">
                            ...
                            <?php if ($component->shouldRender()): ?>
                                ...
                                <?php $__env->slot('options', null, []); ?>
                                <?php $__currentLoopData = $childcategories;
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $childcategory): $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="col-span-12" wire:key="create-service-description" wire:ingore>
                            <?php if (isset($component)) {
                                $__componentOriginalc366661bc2e82de8f861465d0ec8e258 = $component;
                            } ?>
                            <?php if (isset($attributes)) {
                                $__attributesOriginalc366661bc2e82de8f861465d0ec8e258 = $attributes;
                            } ?>
                        ...
                        <div class="col-span-12">
                            <?php if (isset($component)) {
                                $__componentOriginalf6e846e68c722397e62677478fe9e7a5 = $component;
                            } ?>
                            <?php if (isset($attributes)) {
                                $__attributesOriginalf6e846e68c722397e62677478fe9e7a5 = $attributes;
                            } ?>
                        ...
                        <?php if (count($faqs)): ?>
                            <div class="col-span-12">
                                <div class="space-y-4">
                                    ...
                                    $__env->addLoop($__currentLoopData);
                                    foreach ($__currentLoopData as $key => $faq): $__env->incrementLoopIndices();
                                        $loop = $__env->getLastLoop(); ?>
            ...
            <div class="card px-4 py-10 sm:p-10 md:mx-0 mb-6">
                    ...
                    <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                        ...
                        <div class="col-span-12 md:col-span-6" wire:key="create-service-available-deliveries">
                            ...
                            <?php if ($component->shouldRender()): ?>
                                ...
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $key => $delivery): $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
                ...
                <?php $__empty_1 = true;
                $__currentLoopData = $upgrades;
                $__env->addLoop($__currentLoopData);
                foreach ($__currentLoopData as $key => $upgrade): $__env->incrementLoopIndices();
                    $loop = $__env->getLastLoop();
                    $__empty_1 = false; ?>
                            ...
                            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                                ...
                                <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0 mt-4">
                                    <button wire:click="removeUpgrade(<?php echo e($key, false); ?>)" class="inline-flex items-center py-2 ltr:md:pl-3 rtl:md:pr-3 border border-transparent rounded-full bg-transparent hover:bg-transparent focus:outline-none focus:ring-0">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-red-500 hover:text-red-600 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            ...
                            <div class="col-span-12">
                                <div class="flow-root w-full">
                                    <ul role="list">
                                        ...
                                        <?php $__currentLoopData = $requirements;
                                        $__env->addLoop($__currentLoopData);
                                        foreach ($__currentLoopData as $key => $req): $__env->incrementLoopIndices();
                                            $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6 rtl:space-x-reverse">
                                                                    ...
                                                                    <div wire:click="deleteRequirement(<?php echo e($key, false); ?>)" class="mt-2 flex items-center text-xs text-red-600 cursor-pointer">
                                                                        <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 mr-1.5 h-4 w-4 text-red-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                                            <path stroke-linecap="round" stroke-linejoin="round" d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                                                                        </svg>
                    ...
                    <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                        ...
                        <div class="col-span-12 mb-10">
                            ...
                            <div class="w-full" wire:ignore>
                                ...
                                <?php if (isset($component)) {
                                    $__componentOriginal2c6dea5ce283b1b175f902a223d38045 = $component;
                                } ?>
                                <?php if (isset($attributes)) {
                                    $__attributesOriginal2c6dea5ce283b1b175f902a223d38045 = $attributes;
                                } ?>
                            ...
                            <?php if ($errors->has('images.*')): ?>
                                <div class="mt-2 p-4 md:p-5 rounded text-red-700 bg-red-100">
                                    <div class="flex items-center mb-3">
                                        <svg class="inline-block w-5 h-5 ltr:mr-3 rtl:ml-3 flex-none text-red-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <ul class="list-inside ltr:ml-8 rtl:mr-8 space-y-2">
                                        <?php $__currentLoopData = $errors->get('images.*');
                                        $__env->addLoop($__currentLoopData);
                                        foreach ($__currentLoopData as $errors): $__env->incrementLoopIndices();
                                            $loop = $__env->getLastLoop(); ?>
                                            <?php $__currentLoopData = $errors;
                                            $__env->addLoop($__currentLoopData);
                                            foreach ($__currentLoopData as $error): $__env->incrementLoopIndices();
                                                $loop = $__env->getLastLoop(); ?>
                                                <li class="flex items-center text-xs font-semibold">
                                                    <svg class="inline-block w-4 h-4 flex-none ltr:mr-2 rtl:ml-2 rtl:rotate-180" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="col-span-12 mt-10">
                                ...
                                <?php if ($errors->has('documents.*')): ?>
                                    <div class="mt-2 p-4 md:p-5 rounded text-red-700 bg-red-100">
                                        ...
                                        <ul class="list-inside ltr:ml-8 rtl:mr-8 space-y-2">
                                            <?php $__currentLoopData = $errors->get('documents.*');
                                            $__env->addLoop($__currentLoopData);
                                            foreach ($__currentLoopData as $errors): $__env->incrementLoopIndices();
                                                $loop = $__env->getLastLoop(); ?>
                                                <?php $__currentLoopData = $errors;
            ...
            <div class="w-full mt-12">
                <?php if (isset($component)) {
                    $__componentOriginal9a524495f8fba1bb9db48a43313dffc1 = $component;
                } ?>
                <?php if (isset($attributes)) {
                    $__attributesOriginal9a524495f8fba1bb9db48a43313dffc1 = $attributes;
                } ?>
            ...
            <?php if ($component->shouldRender()): ?>
                ...
                <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                    ...
                    <?php if (isset($add_requirement['type']) && $add_requirement['type'] === 'choice'): ?>
                        ...
                        <div class="col-span-12">
                            <?php if (isset($component)) {
                                $__componentOriginaled32a6555010d9a0924dd1854d52b017 = $component;
                            } ?>
                            <?php if (isset($attributes)) {
                                $__attributesOriginaled32a6555010d9a0924dd1854d52b017 = $attributes;
                            } ?>
                        ...
                        <?php $__currentLoopData = $add_requirement['options'];
                        $__env->addLoop($__currentLoopData);
                        foreach ($__currentLoopData as $i => $option): $__env->incrementLoopIndices();
                            $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if (count($add_requirement['options']) > 2): ?>
                                        <div class="absolute inset-y-0 ltr:right-0 rtl:left-0 ltr:pr-3 rtl:pl-3 flex items-center cursor-pointer" wire:click="deleteOption(<?php echo e($i, false); ?>)">
                                            <span class="hover:text-red-500 <?php echo e($errors->first('add_requirement.options.' . $i) ? 'text-red-400' : 'text-gray-400', false); ?>">
                                                <svg class="w-5 h-5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col-span-6">
                            <button wire:click="addOption" type="button" class="text-primary-600 hover:text-white hover:bg-primary-600 border-2 border-primary-600 focus:ring-0 focus:outline-none font-medium rounded text-xs px-5 py-2 text-center inline-flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 ltr:mr-2 rtl:ml-2 ltr:-ml-1 rtl:-mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\taquad\resources\views/livewire/main/create/create.blade.php ENDPATH**/ ?>