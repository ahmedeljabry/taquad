                        ...
                        <div class="px-4 pt-8 flex items-center space-x-3 rtl:space-x-reverse">
                            ...
                            <div class="flex flex-col">
                                <h5
                                    ...
                                    <svg data-popover-target="popover-profile-seller-loyalty-<?php echo e($user->uid, false); ?>"
                                    ...
                                    <div data-popover id="popover-profile-seller-loyalty-<?php echo e($user->uid, false); ?>" role="tooltip"
                                        ...
                                        <div class="px-3 py-2">
                                            <p><?php echo app('translator')->get('messages.t_people_keep_returning_to_username_tooltip', ['username' => $user->username]); ?>
                                            </p>
                                        </div>
                                        <div data-popper-arrow></div>
                                    </div>
                ...
                <div
                    ...
                    <?php if($gigs && $gigs->count()): ?>
                        <section class="px-7 pt-8">
                            ...
                            <div class="mb-5">
                                <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100">
                                    <?php echo app('translator')->get('messages.t_recent_gigs'); ?></h1>
                            </div>
                            ...
                            <div class="grid grid-cols-1 gap-4 lg:gap-8 divide-y dark:divide-zinc-700">
                                <?php $__currentLoopData = $gigs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gig): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex flex-col overflow-hidden [&:not(:first-child)]:pt-4 lg:[&:not(:first-child)]:pt-8"
                                        wire:key="profile-gigs-<?php echo e($gig->uid, false); ?>">
                                        <div
                                            class="flex flex-col grow md:flex-row md:space-x-6 md:space-y-0 rtl:space-x-reverse space-y-4 w-full">

                                            
                                            <a href="<?php echo e(url('service', $gig->slug), false); ?>"
                                                class="flex-none md:w-32 h-min rounded-lg overflow-hidden">
                                                <img src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(src($gig->thumbnail), false); ?>"
                                            ...
                                            <div class="flex-none md:w-48 space-y-4 md:ltr:pr-1 md:rtl:pl-1">
                                                ...
                                                <div
                                                    ...
                                                    <span
                                                        class="text-xs uppercase tracking-wider font-extralight text-gray-400 dark:text-zinc-300 pb-1"><?php echo app('translator')->get('messages.t_starting_at'); ?></span>
                                                    <span
                                                        class="text-base font-medium tracking-wide text-zinc-600 dark:text-zinc-200"><?php echo e(money($gig->price, settings('currency')->code, true), false); ?></span>
                                                </div>

                                                
                                                <div class="flex flex-col">
                                                    <a href="<?php echo e(url('service', $gig->slug), false); ?>" type="button"
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\taquad\resources\views/livewire/main/profile/profile.blade.php ENDPATH**/ ?>