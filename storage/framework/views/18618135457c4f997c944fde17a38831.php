<div class="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 mt-[7rem] py-12 lg:pt-16 lg:pb-24">
    <div class="w-full md:max-w-5xl mx-auto block" x-data="window.rxhfJIyOMMqiyHB">
        ...
        <?php if ($user->availability): ?>
            <div class="p-4 md:p-5 rounded text-orange-700 bg-orange-100 mb-6">
                <div class="flex items-center mb-2">
                    <svg class="inline-block w-5 h-5 ltr:mr-3 rtl:ml-3 flex-none text-orange-500" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="flex items-center md:space-x-3 rtl:space-x-reverse mb-4 md:mb-0 justify-center md:justify-normal space-y-1 md:space-y-0 flex-col md:flex-row">
                                ...
                                <?php if ($user->account_type === 'seller' && !$user->availability): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border border-purple-500 px-3 py-1 text-xs font-normal tracking-wide text-purple-500 whitespace-nowrap">
                                        <svg class="ltr:-ml-1 rtl:-mr-1 ltr:mr-1.5 rtl:ml-1.5 h-4 w-4 text-purple-400" stroke="currentColor" fill="currentColor" stroke-width="0" version="1.2" baseProfile="tiny" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path d="M17.502 12.033l-4.241-2.458 2.138-5.131c.066-.134.103-.285.103-.444 0-.552-.445-1-.997-1-.249.004-.457.083-.622.214l-.07.06-7.5 7.1c-.229.217-.342.529-.306.842.036.313.219.591.491.75l4.242 2.46-2.163 5.19c-.183.436-.034.94.354 1.208.173.118.372.176.569.176.248 0 .496-.093.688-.274l7.5-7.102c.229-.217.342-.529.306-.842-.037-.313-.22-.591-.492-.749z"></path>
                                        </svg>
                                ...
                                <?php if ($user->isOnline()): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border border-green-500 px-3 py-1 text-xs font-normal tracking-wide text-green-500 whitespace-nowrap">
                                        <svg class="ltr:-ml-1 rtl:-mr-1 ltr:mr-1.5 rtl:ml-1.5 h-3 w-3 text-green-400" fill="currentColor" viewBox="0 0 8 8">
                                ...
                                <?php if (!$user->isOnline()): ?>
                                    <span class="inline-flex items-center rounded bg-transparent border border-red-500 px-3 py-1 text-xs font-normal tracking-wide text-red-500 whitespace-nowrap">
                                        <svg class="ltr:-ml-1 rtl:-mr-1 ltr:mr-1.5 rtl:ml-1.5 h-3 w-3 text-red-400" fill="currentColor" viewBox="0 0 8 8">
                                            <circle cx="4" cy="4" r="3"></circle>
                                        </svg>
                    ...
                    <div class="flex items-center space-x-2 rtl:space-x-reverse justify-center md:justify-normal">
                            ...
                            <?php if (auth()->id() != $user->id): ?>
                                <div class="w-9 h-9">
                                    ...
                                    <?php if (isset($component)) {
                                        $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265 = $component;
                                    } ?>
                                    <?php if (isset($attributes)) {
                                        $__attributesOriginalf78ffbe4a2783cbb9a46d3509ee95265 = $attributes;
                                    } ?>
                        ...
                        <div class="w-9 h-9">
                            <button type="button" id="modal-share-profile-button" data-tooltip-target="tooltip-profile-page-share-user" class="text-zinc-400 hover:text-zinc-500 bg-white hover:bg-gray-100 border border-gray-200 cursor-pointer rounded focus:outline-none h-9 w-9 flex items-center justify-center dark:border-zinc-700 dark:bg-zinc-700/40 dark:text-zinc-400 dark:hover:bg-zinc-800">
                                <svg class="h-5 w-5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="bg-white shadow-sm shadow-gray-100 border border-slate-100 dark:border-transparent dark:shadow-none rounded-lg dark:bg-zinc-800 divide-y dark:divide-zinc-700 space-y-8 h-fit pb-8">
                            ...
                            <?php if ($user->headline): ?>
                                <li>
                                    <div class="inline-flex items-start space-x-2 rtl:space-x-reverse">
                                        <div>
                                            <svg class="h-5 w-5" stroke="currentColor" fill="currentColor" stroke-width="0" version="1" viewBox="0 0 48 48" enable-background="new 0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                                                <circle fill="#FFB74D" cx="24" cy="11" r="6"></circle>
                                                <path fill="#607D8B" d="M36,26.1c0,0-3.3-7.1-12-7.1s-12,7.1-12,7.1V30h24V26.1z"></path>
                                                <polygon fill="#B0BEC5" points="41,25 7,25 6,29 11,32 9,29 39,29 37,32 42,29"></polygon>
                            ...
                            <?php if ($user->timezone): ?>
                                ...
                                <li>
                                    <div class="inline-flex items-start space-x-2 rtl:space-x-reverse">
                                        ...
                                        <div>
                                            <?php if ($zone === 'day'): ?>
                                                <svg class="h-5 w-5 text-amber-500 -mt-0.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 20 20" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                                                    <path fill-rule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" clip-rule="evenodd"></path>
                                                </svg>
                                            <?php else: ?>
                                                <svg class="h-4 w-4 text-zinc-500 -mt-[3px]" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="px-4 pt-8 flex items-center space-x-3 rtl:space-x-reverse">
                            ...
                            <div class="flex flex-col">
                                <h5 class="flex items-center space-x-1 rtl:space-x-reverse text-[15px] font-medium text-zinc-700 dark:text-zinc-100">
                                    ...
                                    <svg data-popover-target="popover-profile-seller-loyalty-<?php echo e($user->uid, false); ?>" data-popover-placement="bottom" class="w-4.5 h-4.5 text-gray-500 dark:text-zinc-400 -mt-px" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <?php if ($user->status === 'verified'): ?>
                                    <li class="flex justify-between items-center">
                                        ...
                                        <span class="text-emerald-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase">
                                            <svg class="h-4 w-4" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <?php if (count($user->languages)): ?>
                        <section class="px-5 pt-8">
                            ...
                            <ul class="space-y-3">
                                <?php $__currentLoopData = $user->languages;
                                ...
                                foreach ($__currentLoopData as $lang): $__env->incrementLoopIndices();
                                    ...
                                    <li class="flex justify-between items-center">
                                        <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                            <svg class="h-4 w-4" stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <section class="px-5 pt-8">
                            ...
                            <ul class="space-y-3">
                                ...
                                <?php if ($user_accounts->facebook_profile): ?>
                                    <li class="flex justify-between items-center">
                                        ...
                                        <a href="<?php echo e(url('redirect?to=' . safeEncrypt($user_accounts->facebook_profile)), false); ?>" target="_blank" class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                            <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <?php if ($user_accounts->github_profile): ?>
                                    <li class="flex justify-between items-center">
                                        <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                            <svg class="w-4 h-4" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <?php if ($user_accounts->vimeo_profile): ?>
                                    <li class="flex justify-between items-center">
                                        <span class="font-medium text-sm flex items-center space-x-1 rtl:space-x-reverse dark:text-zinc-400">
                                            <svg class="w-4 h-4" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <?php if ($gigs && $gigs->count()): ?>
                        <section class="px-7 pt-8">
                            ...
                            <div class="grid grid-cols-1 gap-4 lg:gap-8 divide-y dark:divide-zinc-700">
                                ...
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $gig): $__env->incrementLoopIndices();
                                    $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <div class="grow">
                                                ...
                                                <?php if ($gig->delivery_time): ?>
                                                    <div class="flex items-center space-x-1 rtl:space-x-reverse text-xs mb-2 text-gray-500 dark:text-gray-400 tracking-wide font-medium lowercase">
                                                        <svg class="w-4 h-4 text-gray-400 dark:text-gray-500 -mt-px" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <div class="flex-none md:w-48 space-y-4 md:ltr:pr-1 md:rtl:pl-1">
                                                ...
                                                <div class="flex flex-col">
                                                    <a href="<?php echo e(url('service', $gig->slug), false); ?>" type="button" class="inline-flex justify-center items-center space-x-2 rtl:space-x-reverse border font-semibold focus:outline-none px-3 py-2 leading-6 rounded border-gray-300 bg-white text-gray-800 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none text-sm dark:bg-zinc-900 dark:border-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-800 dark:hover:border-zinc-900 dark:hover:text-zinc-300">
                                                        <svg class="opacity-50 inline-block w-4.5 h-4.5" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <?php if ($user->skills && $user->skills()->count()): ?>
                        <section class="px-7 pt-8">
                            ...
                            <div class="text-sm text-gray-500 leading-relaxed">
                                <?php $__currentLoopData = $user->skills;
                                $__env->addLoop($__currentLoopData);
                                foreach ($__currentLoopData as $skill): $__env->incrementLoopIndices();
                                    ...
                                    <a href="<?php echo e(url('hire', $skill->slug), false); ?>" class="inline-flex items-center rounded-3xl border border-gray-200 bg-gray-50 px-3.5 py-1.5 text-xs font-normal text-gray-600 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 tracking-wide ltr:[&:not(:last-child)]:mr-1 rtl:[&:not(:last-child)]:ml-1 mb-2 space-x-1 rtl:space-x-reverse dark:bg-zinc-700 dark:hover:bg-zinc-900 dark:border-zinc-700 dark:hover:border-zinc-900 dark:text-zinc-300">
                                        <?php if ($skill->experience === 'beginner'): ?>
                                            <svg data-tooltip-target="tooltip-profile-skill-experience-<?php echo e($skill->id, false); ?>" class="w-3.5 h-3.5 text-blue-500" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 8 16" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <?php elseif ($skill->experience === 'intermediate'): ?>
                                            <svg data-tooltip-target="tooltip-profile-skill-experience-<?php echo e($skill->id, false); ?>" class="w-3.5 h-3.5 text-amber-500" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 8 16" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" d="M0 8c0-2.2 1.8-4 4-4s4 1.8 4 4-1.8 4-4 4-4-1.8-4-4z"></path>
                                            </svg>
                                            <?php if (isset($component)) {
                                                $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265 = $component;
                                            ...
                                            <?php endif; ?>
                                        <?php else: ?>
                                            <svg data-tooltip-target="tooltip-profile-skill-experience-<?php echo e($skill->id, false); ?>" class="w-3.5 h-3.5 text-green-500" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 8 16" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" d="M0 8c0-2.2 1.8-4 4-4s4 1.8 4 4-1.8 4-4 4-4-1.8-4-4z"></path>
                                            </svg>
                                            <?php if (isset($component)) {
                                                $__componentOriginalf78ffbe4a2783cbb9a46d3509ee95265 = $component;
        ...
        <?php if (auth()->check() && auth()->id() !== $user->id): ?>
            <?php if (isset($component)) {
                $__componentOriginal626cd0ad8c496eb8a190505b15f0d732 = $component;
            } ?>
            <?php if (isset($attributes)) {
                $__attributesOriginal626cd0ad8c496eb8a190505b15f0d732 = $attributes;
            } ?>
            ...
            <?php if ($component->shouldRender()): ?>
                ...
                <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                    ...
                    <div class="col-span-12">
                        <?php if (isset($component)) {
                            $__componentOriginal2f60389a9e230471cd863683376c182f = $component;
                        } ?>
                        <?php if (isset($attributes)) {
                            $__attributesOriginal2f60389a9e230471cd863683376c182f = $attributes;
                        } ?>
                ...
                <?php if (isset($component)) {
                    $__componentOriginal039608dc70b2e4c26356f5d84408f584 = $component;
                } ?>
                <?php if (isset($attributes)) {
                    $__attributesOriginal039608dc70b2e4c26356f5d84408f584 = $attributes;
                } ?>
        ...
        <?php if (auth()->guard()->check()): ?>
            <?php if (settings('publish')->enable_custom_offers && $user->account_type === 'seller'): ?>
                ...
                <?php if ($component->shouldRender()): ?>
                    ...
                    <?php $__env->slot('content', null, []); ?>
                    <?php if (isset($component)) {
                        $__componentOriginala21f49a74cfebdbb98a47509c8a19010 = $component;
                    } ?>
                    <?php if (isset($attributes)) {
                        $__attributesOriginala21f49a74cfebdbb98a47509c8a19010 = $attributes;
                    } ?>
                    ...
                    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                        ...
                        <?php if (settings('publish')->custom_offer_enable_attachments): ?>
                            ...
                            <div class="col-span-12" wire:ignore wire:key='attachments-uploader-form'>
                                <?php if (isset($component)) {
                                    $__componentOriginalb18dd6947576dcfc4eebdb736563555f = $component;
                                } ?>
                                <?php if (isset($attributes)) {
                                    $__attributesOriginalb18dd6947576dcfc4eebdb736563555f = $attributes;
                                } ?>
                            ...
                            <?php if ($errors->has('attachments')): ?>
                                <div class="col-span-12" wire:key='attachments-errors'>
                                    <div class="flex p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400" role="alert">
                                        <svg aria-hidden="true" class="flex-shrink-0 inline w-5 h-5 ltr:mr-3 rtl:ml-3" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                        ...
                                        <div>
                                            ...
                                            <ul class="mt-1.5 ltr:ml-4 rtl:mr-4 list-disc list-inside">
                                                <?php $__currentLoopData = $errors->get('attachments');
                                                $__env->addLoop($__currentLoopData);
                                                foreach ($__currentLoopData as $key => $error): $__env->incrementLoopIndices();
                                                    $loop = $__env->getLastLoop(); ?>
                            ...
                            <div class="col-span-12">
                                <div class="p-4 md:p-5 rounded text-slate-700 bg-slate-50">
                                    <div class="flex items-center mb-3">
                                        <svg class="inline-block w-5 h-5 ltr:mr-3 rtl:ml-3 flex-none text-slate-500" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <ul class="list-inside ltr:ml-8 rtl:mr-8 space-y-2">
                                        ...
                                        <li class="flex items-center text-[13px] tracking-wide">
                                            <svg class="inline-block w-4 h-4 flex-none ltr:mr-2 rtl:pl-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <li>
                                    <div class="relative">
                                        <div class="absolute inset-y-0 left-0 flex items-center ltr:pl-3 rtl:pr-3 pointer-events-none">
                                            <svg class="w-4 h-4 text-gray-300 dark:text-gray-400" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="col-span-12">
                            <?php if (isset($component)) {
                                $__componentOriginal0241d3f51813223308810020791c4a83 = $component;
                            } ?>
                            <?php if (isset($attributes)) {
                                $__attributesOriginal0241d3f51813223308810020791c4a83 = $attributes;
                            } ?>
                        ...
                        <?php if (settings('publish')->custom_offers_commission_value_buyer > 0): ?>
                            ...
                            <div class="col-span-12">
                                <div class="flex items-start space-x-1 rtl:space-x-reverse text-[13px] italic text-slate-400 tracking-wide">
                                    <svg class="h-5 w-5 flex-shrink-0" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex flex-col items-center px-4">
                    ...
                    <div class="sharing-buttons flex flex-wrap -mx-1 justify-center mt-2">
                        ...
                        <a class="bg-[#126567] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8" target="_blank" rel="noopener" href="https://www.xing.com/app/user?op=share;url=<?php echo e(url('profile', $user->username), false); ?>;title=<?php echo e($user->fullname ? $user->fullname : $user->username, false); ?>" aria-label="Share on Xing" draggable="false">
                            <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                                <title>Xing</title>
                                <path d="m227 210-70 123c-5 9-11 13-18 13H74c-8 0-12-8-9-14l69-122-44-76c-4-7 1-14 9-14h65c7 0 13 4 18 12l45 78zM447 46 303 299l91 167c4 7 0 14-8 14h-66c-7 0-13-4-18-12l-92-169L355 44c4-8 10-12 17-12h66c8 0 12 7 9 14z"> </path>
                            </svg>
                        </a>
                        ...
                        <a class="bg-[#4C75A3] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8" target="_blank" rel="noopener" href="http://vk.com/share.php?title=<?php echo e($user->fullname ? $user->fullname : $user->username, false); ?>&amp;url=<?php echo e(url('profile', $user->username), false); ?>" aria-label="Share on VK" draggable="false">
                            <svg aria-hidden="true" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="w-4 h-4">
                                <title>VK</title>
                                <path d="M63 63c-31 32-31 83-31 184v18c0 101 0 152 31 184s83 31 184 31h18c101 0 152 0 184-31s31-83 31-184v-18c0-101 0-152-31-184s-83-31-184-31h-18C146 32 95 32 63 63zm45 105h51c1 86 39 122 69 129V168h48v74c30-3 61-37 71-74h48a142 142 0 0 1-65 93 147 147 0 0 1 76 94h-53a92 92 0 0 0-77-67v67h-6c-102 0-160-70-162-187z"> </path>
                            </svg>
                        </a>
                        ...
                        <div class="bg-slate-100 rounded p-3 dark:bg-zinc-700">
                            <div tabindex="0" aria-label="copy link" class="focus:outline-none flex items-center justify-between">
                                <div class="flex items-center">
                                    <svg class="focus:outline-none h-4 text-slate-400 w-4 dark:text-zinc-400" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
