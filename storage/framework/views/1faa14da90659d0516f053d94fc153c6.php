...
?>
<!--[if BLOCK]><![endif]--><?php if(!empty($name)): ?>
    <!--[if BLOCK]><![endif]--><?php if(substr($name, 0,4) === '<svg'): ?> 
        <?php echo $name; ?>
...
<?php endif; ?><!--[if ENDBLOCK]><![endif]--><?php /**PATH C:\xampp\htdocs\taquad\resources\views/components/bladewind/icon.blade.php ENDPATH**/ ?>