                ...
                <div class="mt-7">
                    <ol class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $wizardSteps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wizardStep): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            ?>
                            <li wire:key="wizard-step-<?php echo e($wizardStep['id'], false); ?>">
                                <button type="button" <?php if(!$isLocked): ?> wire:click="$set('step', <?php echo e($wizardStep['id'], false); ?>)"
                                <?php endif; ?> <?php if($isLocked): echo 'disabled'; endif; ?> class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                    ...
                                    <span class="<?php echo \Illuminate\Support\Arr::toCssClasses([
                                        ...
                                        <span><?php echo e($wizardStep['id'] + 1, false); ?></span>
                                    </span>
                            ...
                            <div class="grid gap-5 md:grid-cols-2">
                                ...
                                <label
                                    ...
                                    <span class="absolute top-3 inline-flex items-center rounded-full bg-slate-100 px-2 py-0.5 text-[10px] font-semibold tracking-wide text-slate-600 rtl:right-4 ltr:left-4 dark:bg-zinc-700 dark:text-zinc-200">
                                        <?php echo app('translator')->get('messages.t_coming_soon'); ?>
                                    </span>
                                    ...
                                    <span class="flex flex-col">
                                        ...
                                        <span class="text-[12.5px] text-slate-500 dark:text-zinc-400">
                                            <?php echo app('translator')->get('messages.t_hourly_projects_coming_soon'); ?>
                                        </span>
                                    </span>
                                </label>
                            </div>
