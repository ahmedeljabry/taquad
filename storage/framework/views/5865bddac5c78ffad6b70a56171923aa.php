...
<?php endif; ?>
    <span class="text-gray-400/80 dark:text-zinc-300 px-6 pl-10 zoom-out inline-block selection text-xs">
        ...
        <!--[if BLOCK]><![endif]--><?php if($required): ?> <span class="text-red-300">*</span><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    </span>
    <div class="w-0 h-0 overflow-hidden">
        <input 
            ...
            <!--[if BLOCK]><![endif]--><?php if(!empty($selected_value)): ?><input type="hidden" class="selected_<?php echo e($name, false); ?>" name="selected_<?php echo e($name, false); ?>" value="<?php echo e($selected_value, false); ?>" /><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    </div>
</div>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        <!--[if BLOCK]><![endif]--><?php if(!empty($url)): ?>
            <!--[if BLOCK]><![endif]--><?php if(in_array(pathinfo($url, PATHINFO_EXTENSION), $image_file_types)): ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\xampp\htdocs\taquad\resources\views/components/bladewind/filepicker.blade.php ENDPATH**/ ?>