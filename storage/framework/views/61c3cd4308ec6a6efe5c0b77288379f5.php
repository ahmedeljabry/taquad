        ...
        <div class="relative mx-auto flex flex-col gap-6 lg:max-w-6xl lg:flex-row lg:items-center lg:justify-between">
            <div class="space-y-4">
                ...
                <div class="flex flex-wrap gap-3 text-[12px] font-semibold uppercase tracking-[0.2em] text-white/80">
                    ...
                    <?php if(auth()->user()->freelancerProjectLevel): ?>
                        <span class="inline-flex items-center gap-2 rounded-full bg-white/15 px-3 py-1">
                            <i class="ph ph-medal"></i>
                            <?php echo e(auth()->user()->freelancerProjectLevel->label, false); ?>

                        </span>
                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                    <!--[if BLOCK]><![endif]--><?php if((int) auth()->user()->project_rating_count > 0): ?>
                        <span class="inline-flex items-center gap-2 rounded-full bg-white/15 px-3 py-1">
                            <i class="ph ph-star"></i>
                            <?php echo e(number_format(auth()->user()->project_rating_avg, 1), false); ?> ·
                            <?php echo e(__('messages.t_number_reviews', ['number' => auth()->user()->project_rating_count]), false); ?>
