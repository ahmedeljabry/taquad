		...
		<div class="mb-12 container xl:max-w-7xl mx-auto px-4 lg:px-8 mt-8">
			<div class="p-4 md:p-5 rounded text-slate-700 bg-slate-100">
				<div class="flex items-center mb-2">
					<svg class="nline-block w-5 h-5 mr-3 flex-none text-slate-500" stroke="currentColor" fill="currentColor"
				...
				<ul class="list-inside ltr:ml-8 rtl:mr-8 space-y-6 text-sm flex flex-col">
					...
					<li class="inline-flex">
						<svg class="hi-solid hi-arrow-narrow-right inline-block w-4 h-4 flex-none ltr:mr-4 rtl:ml-4"
						...
						<div>
							...
							<kbd
								class="flex font-semibold items-center py-1.5 rounded rtl:space-x-reverse space-x-3 text-gray-800 text-xs">
								<div class="flex items-center space-x-1 rtl:space-x-reverse">
									<svg stroke="currentColor" fill="currentColor" stroke-width="0" version="1"
										viewBox="0 0 48 48" enable-background="new 0 0 48 48" class="w-4 h-4"
				...
				<div class="h-full w-full xl:grid xl:grid-cols-2">
					<div class="h-full xl:relative xl:col-start-2">
						<img class="h-full w-full object-cover opacity-25 xl:absolute xl:inset-0 ltr:rounded-r-lg rtl:rounded-l-lg lazy"
							src="<?php echo e(placeholder_img(), false); ?>" data-src="<?php echo e(url('public/img/start_selling/1.jpg'), false); ?>"
							alt="<?php echo e(__('messages.t_u_bring_the_skill_make_earn_easy'), false); ?>">
						<div aria-hidden="true"
							class="absolute inset-x-0 top-0 h-32 bg-gradient-to-b from-zinc-900 xl:inset-y-0 ltr:xl:left-0 rtl:xl:right-0 xl:h-full xl:w-32 xl:bg-gradient-to-r rtl:rotate-180">
						</div>
					</div>
				</div>
			</div>
			<div
				...
				<div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
					...
					<div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
						...
						<p>
							<span
								class="block text-xl font-bold text-white uppercase"><?php echo e(__('messages.t_4_sec'), false); ?></span>
						<span
							class="mt-1 block text-base text-gray-300"><?php echo e(__('messages.t_active_monthly_visits'), false); ?></span>
						</p>

						
						<p>
							<span
								class="block text-xl font-bold text-white uppercase"><?php echo e(__('messages.t_50_m_plus'), false); ?></span>
						...
						<p>
							<span class="block text-xl font-bold text-white uppercase">
								<?php echo e(money(5, settings('currency')->code, true), false); ?> -
								<?php echo e(money(10000, settings('currency')->code, true), false); ?>
						...
						<p>
							<span
								class="block text-xl font-bold text-white uppercase"><?php echo e(__('messages.t_5_million'), false); ?></span>
							<span
								class="mt-1 block text-base text-gray-300"><?php echo e(__('messages.t_active_monthly_visits'), false); ?></span>
						</p>
			...
			<!--[if BLOCK]><![endif]--><?php $__currentLoopData = $sellers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seller): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<div>
					<div class="group relative p-4 mb-5 min-h-[190px flex]">
						<div
							class="absolute inset-0 rounded-lg bg-primary-100 transform transition ease-out duration-150 skew-y-2 group-hover:-rotate-2">
						</div>
						<img src="<?php echo e(placeholder_img(), false); ?>"
							data-src="<?php echo e(url('public/img/start_selling/' . $seller['avatar']), false); ?>"
							alt="<?php echo e($seller['name'], false); ?>" class="relative rounded-lg shadow object-cover lazy">
					</div>
			...
			<div class="max-w-xl mx-auto lg:max-w-none">
				...
				<div class="mt-12 max-w-sm mx-auto grid grid-cols-1 gap-y-10 gap-x-8 sm:max-w-none lg:grid-cols-3">
					...
					<div class="text-center sm:flex sm:text-left lg:block lg:text-center">
						...
						<div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
							...
							<p class="mt-2 text-sm text-primary-100">
								<?php echo e(__('messages.t_start_selling_t_create_a_gig_subtitle'), false); ?></p>
						</div>
					</div>
					...
					<div class="text-center sm:flex sm:text-left lg:block lg:text-center">
						<div class="sm:flex-shrink-0">
							<div class="flow-root">
								<svg class="w-16 h-16 mx-auto text-primary-200" stroke="currentColor" fill="none"
						...
						<div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
							<h3 class="text-base font-extrabold text-white"><?php echo e(__('messages.t_deliver_great_work'), false); ?>

							</h3>
							<p class="mt-2 text-sm text-primary-100"><?php echo e(__('messages.t_deliver_great_work_subtitle'), false); ?>
	...
	<div class="mb-24 container xl:max-w-7xl mx-auto px-4 lg:px-8">
		...
		<div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
			...
			<div class="border rounded-md bg-white dark:bg-zinc-800 dark:border-zinc-700 shadow-sm relative">
				<div
					class="absolute top-0 right-0 text-8xl mt-1 mr-2 text-indigo-200 dark:text-zinc-500 opacity-75 font-serif">
					“</div>
				<div class="px-4 pt-14 pb-6 sm:px-6 sm:pb-6 relative">
					<blockquote>
						...
						<footer class="flex items-center space-x-4 rtl:space-x-reverse">
							<div
								class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
								<img src="<?php echo e(placeholder_img(), false); ?>"
									data-src="<?php echo e(url('public/img/start_selling/9.jpg'), false); ?>"
									alt="<?php echo e(__('messages.t_fake_name_alex_saunders'), false); ?>"
									class="object-cover w-12 h-12 lazy">
							</div>
							<div>
					...
					<blockquote>
						...
						<footer class="flex items-center space-x-4 rtl:space-x-reverse">
							<div
								class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
								<img src="<?php echo e(placeholder_img(), false); ?>"
									data-src="<?php echo e(url('public/img/start_selling/7.jpg'), false); ?>"
									alt="<?php echo e(__('messages.t_fake_name_ricky_jones'), false); ?>"
									class="object-cover w-12 h-12 lazy">
							</div>
							<div>
								<div class="font-semibold text-primary-600 hover:text-primary-400">
					...
					<blockquote>
						...
						<footer class="flex items-center space-x-4 rtl:space-x-reverse">
							<div
								class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
								<img src="<?php echo e(placeholder_img(), false); ?>"
									data-src="<?php echo e(url('public/img/start_selling/8.jpg'), false); ?>"
									alt="<?php echo e(__('messages.t_fake_name_melissa_ross'), false); ?>"
									class="object-cover w-12 h-12 lazy">
							</div>
							<div>
								<div class="font-semibold text-primary-600 hover:text-primary-400">
	...
	<div class="mb-24 container xl:max-w-7xl mx-auto px-4 lg:px-8">
		...
		<div class="text-center mb-12">
			<div class="relative inline-flex w-20 h-20 items-center justify-center text-emerald-500 mb-10 mx-auto">
				...
				<div class="relative">
					<svg fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
						class="hi-solid hi-fire inline-block w-10 h-10">
						<path fill-rule="evenodd"
			...
			<h2 class="text-3xl md:text-4xl font-extrabold mb-4 dark:text-gray-200">
				<?php echo app('translator')->get('messages.t_signup_and_create_ur_first_gig'); ?> <span
					class="text-primary-600"><?php echo app('translator')->get('messages.t_today'); ?></span>!
			</h2>
			<h3
				class="text-lg md:text-xl md:leading-relaxed font-medium text-gray-600 dark:text-gray-400 lg:w-2/3 mx-auto">
			...
			<div class="text-center">
				<a href="<?php echo e(url('auth/register'), false); ?>"
					...
					<svg xmlns="http://www.w3.org/2000/svg"
						class="opacity-50 hi-solid hi-arrow-right hidden rtl:inline-block w-5 h-5" viewBox="0 0 20 20"
						fill="currentColor">
						<path fill-rule="evenodd"
...
<?php /**PATH C:\xampp\htdocs\taquad\resources\views/livewire/main/become/seller.blade.php ENDPATH**/ ?>