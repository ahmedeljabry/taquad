...
<label class="relative <?php if(!$justified): ?>inline-flex <?php else: ?> flex justify-between <?php endif; ?> items-center group" onclick="<?php echo $onclick; ?>">
    <!--[if BLOCK]><![endif]--><?php if($label_position == 'left' && $label !== ''): ?><span class="ltr:pr-3 rtl:pl-3 <?php echo e($class, false); ?>"><?php echo $label; ?></span><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
    ...
    <!--[if BLOCK]><![endif]--><?php if($label_position=='right' && $label !== ''): ?><span class="ltr:pl-3 rtl:pr-3 text-xs+ text-gray-500 dark:text-zinc-300 cursor-pointer <?php echo e($class, false); ?>"><?php echo $label; ?></span><?php endif; ?><!--[if ENDBLOCK]><![endif]-->
</label><?php /**PATH C:\xampp\htdocs\taquad\resources\views/components/bladewind/toggle.blade.php ENDPATH**/ ?>