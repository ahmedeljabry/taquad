...
<div class="relative bw-select bw-select-<?php echo e($input_name, false); ?> <?php if($add_clearing): ?> <?php endif; ?>"
     data-bw-select="<?php echo e($input_name, false); ?>"
     data-placeholder="<?php echo e(e($placeholder), false); ?>"
     data-component="<?php echo e($componentId, false); ?>"
     data-model="<?php echo e(($data_serialize_as !== '') ? $data_serialize_as : $name, false); ?>"
     data-disabled="<?php echo e(filter_var($disabled, FILTER_VALIDATE_BOOLEAN) ? 'true' : 'false', false); ?>"
     data-readonly="<?php echo e(filter_var($readonly, FILTER_VALIDATE_BOOLEAN) ? 'true' : 'false', false); ?>"
     data-multiple="<?php echo e($multiple, false); ?>"
     data-type="<?php echo e($data !== 'manual' ? 'dynamic' : 'manual', false); ?>"
...
<?php endif; ?>
    ...
    <div class="w-full absolute z-30 rounded-md bg-white shadow-sm border 
        ...
        <!--[if BLOCK]><![endif]--><?php if($data !== 'manual'): ?>
...
<?php /**PATH C:\xampp\htdocs\taquad\resources\views/components/bladewind/select.blade.php ENDPATH**/ ?>