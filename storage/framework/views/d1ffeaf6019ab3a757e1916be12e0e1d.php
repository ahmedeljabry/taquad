...
$__html = app('livewire')->mount($__name, $__params, 'lw-404610254-0', $__slots ?? [], get_defined_vars());
            ...
            <header x-bind:class="{
                ...
                <div class="flex justify-between max-w-10xl mx-auto px-4 lg:px-8 w-full">
                    ...
                    <div class="flex items-center space-x-2 rtl:space-x-reverse">
                        ...
                        <button type="button" class=" relative inline-flex justify-center items-center space-x-2 border font-semibold focus:outline-none px-3 py-2 leading-5 text-sm rounded border-gray-300 bg-white text-gray-700 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none dark:bg-zinc-700 dark:border-zinc-600 dark:text-zinc-300 dark:hover:bg-zinc-800" data-drawer-target="notifications-drawer" data-drawer-show="notifications-drawer" aria-controls="notifications-drawer" style="z-index:999;" data-drawer-placement="right" data-drawer-backdrop="false">
...
$__html = app('livewire')->mount($__name, $__params, 'lw-404610254-1', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\xampp\htdocs\taquad\resources\views/components/layouts/admin-app.blade.php ENDPATH**/ ?>