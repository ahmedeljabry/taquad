        ...
        <ol role="list" class="flex items-center space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    <svg class="h-4 w-4 flex-shrink-0 text-gray-300 reflection dark:text-zinc-600" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20" aria-hidden="true">
...
</div><?php /**PATH C:\xampp\htdocs\taquad\resources\views/livewire/main/explore/projects/category.blade.php ENDPATH**/ ?>