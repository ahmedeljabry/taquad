...
<div id="ai-support-widget" class="ai-support-widget" data-ai-widget data-config='@json($aiWidgetConfig, JSON_UNESCAPED_UNICODE)'>
    ...
    <div id="ai-support-panel" class="ai-support-panel" data-widget-panel hidden>
        <div class="ai-support-header">
            <div>
                <p class="ai-support-header__title">{{ $aiWidgetConfig['copy']['title'] }}</p>
                <p class="ai-support-header__subtitle">{{ $aiWidgetConfig['copy']['tagline'] }}</p>
            </div>
            <button type="button" class="ai-support-close" data-widget-close aria-label="{{ __('messages.t_close') }}">
                <i class="ph ph-x"></i>
            </button>
        </div>

        <div class="ai-support-tabs">
            <button type="button" class="is-active" data-widget-tab="assistant">{{ $aiWidgetConfig['copy']['assistantTab'] }}</button>
            <button type="button" data-widget-tab="ticket">{{ $aiWidgetConfig['copy']['ticketTab'] }}</button>
        </div>
            ...
            <section data-widget-pane="assistant" class="is-active">
                <div class="ai-support-chat" data-widget-chat-log>
                    ...
                    <div class="ai-support-message is-assistant">
                        <span>{{ $aiWidgetConfig['copy']['greeting'] }}</span>
                    </div>
                </div>

                <form class="ai-support-chat-form" data-widget-chat-form>
                    <input type="text" data-widget-chat-input autocomplete="off" placeholder="{{ $aiWidgetConfig['copy']['inputPlaceholder'] }}">
                    <button type="submit" aria-label="{{ $aiWidgetConfig['copy']['send'] }}">
                ...
                <form class="ai-support-ticket" data-widget-ticket-form novalidate>
                    <div class="ai-support-grid">
                        <label class="ai-support-label">
                            <span>{{ $aiWidgetConfig['copy']['name'] }}</span>
                            <input type="text" name="name" required>
                        </label>
                        <label class="ai-support-label">
                            <span>{{ $aiWidgetConfig['copy']['email'] }}</span>
                    ...
                    <div>
                        <label class="ai-support-label">
                            <span>{{ $aiWidgetConfig['copy']['topic'] }}</span>
                            <input type="text" name="topic" placeholder="{{ $aiWidgetConfig['copy']['topicPlaceholder'] }}">
                        </label>
                        <label class="ai-support-label" style="display:none !important;">
                            <span>{{ $aiWidgetConfig['copy']['priority'] }}</span>
                            <select name="priority">
                                <option value="normal" selected>{{ $aiWidgetConfig['copy']['priorityNormal'] }}</option>
                                <option value="high">{{ $aiWidgetConfig['copy']['priorityHigh'] }}</option>
                                <option value="low">{{ $aiWidgetConfig['copy']['priorityLow'] }}</option>
                            </select>
                        </label>
                    </div>

                    <label class="ai-support-label">
                        <span>{{ $aiWidgetConfig['copy']['message'] }}</span>
                        <textarea name="message" rows="4" required placeholder="{{ $aiWidgetConfig['copy']['messagePlaceholder'] }}"></textarea>
                    </label>

                    <p class="ai-support-ticket-hint">{{ $aiWidgetConfig['copy']['ticketHint'] }}</p>

                    <button type="submit" class="ai-support-submit" data-widget-ticket-submit>
                        <span>{{ $aiWidgetConfig['copy']['submit'] }}</span>
...
@once
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const supportEndpoint = "{{ route('support.widget.store') }}";
