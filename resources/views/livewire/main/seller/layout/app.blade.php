<!DOCTYPE html>
@php
    $sellerTheme = current_theme();
    $sellerPreference = in_array($sellerTheme, ['light', 'dark']) ? $sellerTheme : 'system';
@endphp
<html lang="{{ app()->getLocale() }}" dir="{{ config()->get('direction') }}"
    data-theme-preference="{{ $sellerPreference }}"
    data-theme="{{ $sellerTheme === 'dark' ? 'dark' : 'light' }}"
    ...
    @class(['dark' => $sellerTheme === 'dark', 'h-full'])>
	<head>
		<meta charset="UTF-8">
