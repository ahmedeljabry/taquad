				...
				<div class="h-full w-full xl:grid xl:grid-cols-2">
					<div class="h-full xl:relative xl:col-start-2">
						<img class="h-full w-full object-cover opacity-25 xl:absolute xl:inset-0 ltr:rounded-r-lg rtl:rounded-l-lg lazy"
							src="{{ placeholder_img() }}" data-src="{{ url('public/img/start_selling/1.jpg') }}"
			...
			<div
				...
				<div class="relative pt-12 pb-64 sm:pt-24 sm:pb-64 xl:col-start-1 xl:pb-24">
					...
					<div class="mt-12 grid grid-cols-1 gap-y-12 gap-x-6 sm:grid-cols-2">
						...
						<p>
							<span
								class="block text-xl font-bold text-white uppercase">{{ __('messages.t_50_m_plus') }}</span>
						...
						<p>
							<span class="block text-xl font-bold text-white uppercase">
								{{ money(5, settings('currency')->code, true) }} -
								{{ money(10000, settings('currency')->code, true) }}
							</span>
						...
						<p>
							<span
								class="block text-xl font-bold text-white uppercase">{{ __('messages.t_5_million') }}</span>
							<span
								class="mt-1 block text-base text-gray-300">{{ __('messages.t_active_monthly_visits') }}</span>
						</p>
				...
				<div>
					<div class="group relative p-4 mb-5 min-h-[190px flex]">
						...
						<img src="{{ placeholder_img() }}"
							data-src="{{ url('public/img/start_selling/' . $seller['avatar']) }}"
							alt="{{ $seller['name'] }}" class="relative rounded-lg shadow object-cover lazy">
					</div>
			...
			<div class="max-w-xl mx-auto lg:max-w-none">
				...
				<div class="mt-12 max-w-sm mx-auto grid grid-cols-1 gap-y-10 gap-x-8 sm:max-w-none lg:grid-cols-3">
					...
					<div class="text-center sm:flex sm:text-left lg:block lg:text-center">
						...
						<div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
							...
							<p class="mt-2 text-sm text-primary-100">
								{{ __('messages.t_start_selling_t_create_a_gig_subtitle') }}</p>
						</div>
					</div>
					...
					<div class="text-center sm:flex sm:text-left lg:block lg:text-center">
						...
						<div class="mt-3 sm:mt-0 sm:ml-6 lg:mt-6 lg:ml-0">
							<h3 class="text-base font-extrabold text-white">{{ __('messages.t_deliver_great_work') }}
							</h3>
							<p class="mt-2 text-sm text-primary-100">{{ __('messages.t_deliver_great_work_subtitle') }}
							</p>
						</div>
					</div>
					...
					<blockquote>
						...
						<footer class="flex items-center space-x-4 rtl:space-x-reverse">
							<div
								...
								<img src="{{ placeholder_img() }}"
									data-src="{{ url('public/img/start_selling/9.jpg') }}"
									alt="{{ __('messages.t_fake_name_alex_saunders') }}"
					...
					<blockquote>
						...
						<footer class="flex items-center space-x-4 rtl:space-x-reverse">
							<div
								class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
								<img src="{{ placeholder_img() }}"
									data-src="{{ url('public/img/start_selling/7.jpg') }}"
									alt="{{ __('messages.t_fake_name_ricky_jones') }}"
									class="object-cover w-12 h-12 lazy">
							</div>
							<div>
								<div class="font-semibold text-primary-600 hover:text-primary-400">
					...
					<blockquote>
						...
						<footer class="flex items-center space-x-4 rtl:space-x-reverse">
							<div
								class="flex-none rounded-full overflow-hidden w-12 h-12 transform transition ease-out duration-150 dark:hover:bg-zinc-700 hover:shadow-md hover:scale-125 active:shadow-sm active:scale-110">
								<img src="{{ placeholder_img() }}"
									data-src="{{ url('public/img/start_selling/8.jpg') }}"
									alt="{{ __('messages.t_fake_name_melissa_ross') }}"
									class="object-cover w-12 h-12 lazy">
							</div>
							<div>
								<div class="font-semibold text-primary-600 hover:text-primary-400">
	...
	<div class="mb-24 container xl:max-w-7xl mx-auto px-4 lg:px-8">
		...
		<div class="text-center mb-12">
			...
			<h2 class="text-3xl md:text-4xl font-extrabold mb-4 dark:text-gray-200">
				@lang('messages.t_signup_and_create_ur_first_gig') <span
					class="text-primary-600">@lang('messages.t_today')</span>!
			</h2>
			<h3
