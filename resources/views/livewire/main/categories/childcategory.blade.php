<div class="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 mt-[7rem] py-12 lg:pt-16 lg:pb-24"
    x-data="window.AxZSIHcEeIYErvQ" x-init="initialize()" @keydown.window.escape="open = false" x-cloak>
                    ...
                    <div class="pt-6 px-4" x-show="open" style="display: none;">
                        <div class="space-y-4">
                            ...
                            @foreach ($delivery_times as $key => $time)
                                <div class="flex items-center">
                                    <input wire:model.defer="delivery_time" id="filter-delivery-time-{{ $key }}"
    ...
    <main class="max-w-7xl mx-auto">
        ...
        <div
            ...
            <div>
                <span
                    class="font-extrabold text-base text-gray-800 dark:text-gray-100 pb-1 block tracking-wider">{{ $childcategory->name }}</span>
