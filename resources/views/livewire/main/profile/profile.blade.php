    ...
    <div class="w-full md:max-w-5xl mx-auto block" x-data="window.rxhfJIyOMMqiyHB">
            ...
            <div class="p-4 md:p-5 rounded text-orange-700 bg-orange-100 mb-6">
                <div class="flex items-center mb-2">
                    ...
                    <h3 class="font-semibold">
                        {{ __('messages.t_this_user_is_not_available_right_now_msg', ['date' => format_date($user->availability?->expected_available_date, config('carbon-formats.F_j,_Y'))]) }}
                    </h3>
                </div>
                        ...
                        <div class="text-center md:text-left space-y-3">
                            ...
                            <div class="flex items-center mb-2 justify-center md:justify-normal">
                                ...
                                @if ($user->status === 'verified')
                                    <div>
                                        <img data-popover-target="popover-profile-verified-{{ $user->uid }}"
                                        ...
                                        <div data-popover id="popover-profile-verified-{{ $user->uid }}" role="tooltip"
                                            ...
                                            <div class="px-3 py-2">
                                                <p>@lang('messages.t_this_freelancer_id_has_verified_gov_id_check_tooltip')
                                                </p>
                                            </div>
                            ...
                            <div
                                ...
                                @if ($user->level)
                                    <span
                                        ...
                                        style="color: {{ $user->level->level_color }};border-color: {{ $user->level->level_color }};">
                    ...
                    <div class="flex items-center space-x-2 rtl:space-x-reverse justify-center md:justify-normal">
                        ...
                        @auth
                            @if (settings('publish')->enable_custom_offers && auth()->id() != $user->id && $user->account_type === 'seller')
                                <a href="{{ route('invite.freelancer', ['username' => $user->username]) }}"
                        ...
                        @auth
                            @if (auth()->id() != $user->id)
                                <div class="w-9 h-9">
                                    ...
                                    <x-forms.tooltip id="tooltip-profile-page-contact-user"
                                        :text="__('messages.t_contact_me')" />
                                </div>
                            @endif
                        @endauth
                        ...
                        <div class="w-9 h-9">
                            ...
                            <x-forms.tooltip id="tooltip-profile-page-share-user"
                                :text="__('messages.t_share_profile')" />
                        </div>
                        ...
                        @auth
                            @if ($user->id != auth()->id())
                                <div class="w-9 h-9">
                                    ...
                                    <x-forms.tooltip id="tooltip-profile-page-report-user"
                                        :text="__('messages.t_report_user')" />
                                </div>
                            @endif
                        @endauth
                ...
                <div
                        ...
                        <ul class="list-inside text-gray-500 dark:text-zinc-300 text-sm space-y-3">
                                    ...
                                    <div class="inline-flex items-center space-x-2 rtl:space-x-reverse">
                                        <div class="w-5 flex justify-center">
                                            <img src="{{ placeholder_img() }}"
                                                data-src="{{ url('public/img/flags/' . strtolower($user->country->code) . '.svg') }}"
                                                alt="{{ $user->country->name }}" class="lazy h-3">
                                        </div>
                                        <div>
                                            @if ($user->city)
                            ...
                            <li>
                                <div class="inline-flex items-start space-x-2 rtl:space-x-reverse">
                                    ...
                                    <span>@lang('messages.t_member_since')
                                        {{ format_date($user->created_at, config('carbon-formats.F_j,_Y')) }}</span>
                                </div>
                            </li>
                        ...
                        <section class="px-5 pt-8">
                            ...
                            <div class="mb-5">
                                <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100">
                                    @lang('messages.t_verifications')</h1>
                            </div>
                            ...
                            <ul class="space-y-2">
                                ...
                                @if ($user->email_verified_at)
                                    <li class="flex justify-between items-center">
                                        <span
                                            class="font-normal text-sm dark:text-zinc-400">@lang('messages.t_email_address')</span>
                                        <span
                                            class="text-emerald-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase">
                                            <svg class="h-4 w-4" stroke="currentColor" fill="currentColor" stroke-width="0"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    @if (settings('security')->is_social_media_accounts && $user_accounts && $user_accounts->exists() && ($user_accounts->facebook_profile || $user_accounts->twitter_profile || $user_accounts->dribbble_profile || $user_accounts->stackoverflow_profile || $user_accounts->github_profile || $user_accounts->youtube_profile || $user_accounts->vimeo_profile))
                        <section class="px-5 pt-8">
                            ...
                            <div class="mb-5">
                                <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100">
                                    @lang('messages.t_linked_accounts')</h1>
                            </div>
                            ...
                            <ul class="space-y-3">
                                ...
                                @if ($user_accounts->facebook_profile)
                                    <li class="flex justify-between items-center">
                                        ...
                                        <a href="{{ url('redirect?to=' . safeEncrypt($user_accounts->facebook_profile)) }}"
                                            target="_blank"
                                ...
                                @if ($user_accounts->twitter_profile)
                                    <li class="flex justify-between items-center">
                                        ...
                                        <a href="{{ url('redirect?to=' . safeEncrypt($user_accounts->twitter_profile)) }}"
                                            target="_blank"
                                            class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                            <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                @if ($user_accounts->dribbble_profile)
                                    <li class="flex justify-between items-center">
                                        ...
                                        <a href="{{ url('redirect?to=' . safeEncrypt($user_accounts->dribbble_profile)) }}"
                                            target="_blank"
                                            class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                            <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                @if ($user_accounts->stackoverflow_profile)
                                    <li class="flex justify-between items-center">
                                        ...
                                        <a href="{{ url('redirect?to=' . safeEncrypt($user_accounts->stackoverflow_profile)) }}"
                                            target="_blank"
                                            class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                            <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                @if ($user_accounts->github_profile)
                                    <li class="flex justify-between items-center">
                                        ...
                                        <a href="{{ url('redirect?to=' . safeEncrypt($user_accounts->github_profile)) }}"
                                            target="_blank"
                                            class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                            <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                @if ($user_accounts->youtube_profile)
                                    <li class="flex justify-between items-center">
                                        ...
                                        <a href="{{ url('redirect?to=' . safeEncrypt($user_accounts->youtube_profile)) }}"
                                            target="_blank"
                                            class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                            <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                @if ($user_accounts->vimeo_profile)
                                    <li class="flex justify-between items-center">
                                        ...
                                        <a href="{{ url('redirect?to=' . safeEncrypt($user_accounts->vimeo_profile)) }}"
                                            target="_blank"
                                            class="text-gray-500 text-sm flex items-center space-x-1 rtl:space-x-reverse lowercase hover:text-blue-500 dark:text-zinc-400 dark:hover:text-blue-400">
                                            <svg class="w-3.5 h-3.5" stroke="currentColor" fill="currentColor" stroke-width="0"
                                                viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <section class="px-5 py-8">
                            ...
                            <div class="flex flex-col items-center gap-2">
                                ...
                                <span class="flex items-center gap-4 text-sm rounded text-slate-500">
                                    ...
                                    {{-- Rating value --}}
                                    <span class="text-base font-bold text-amber-500">{{ $user_rating['value'] }}
                                        @lang('messages.t_out_of_5')</span>

                                </span>

                                {{-- Total reviews --}}
                                <span
                                    class="text-sm leading-6 text-slate-400">@lang('messages.t_based_on_number_reviews', ['number' => $user_rating['total']])</span>
                                ...
                                <div class="flex flex-col w-full gap-4 pt-6">
                                    ...
                                    <span class="flex items-center w-full gap-2">
                                        <label
                                            class="mb-0 text-xs text-center w-12 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex">@lang('messages.t_5_stars')</label>
                                        <progress max="100"
                                            value="{{ $user_rating['stars_5'] * 100 / $user_rating['total'] }}"
                                            class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400">{{ $user_rating['stars_5'] * 100 / $user_rating['total'] }}%</progress>
                                        <span
                                            class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300">{{ $user_rating['stars_5'] }}</span>
                                    </span>

                                    {{-- 4 star --}}
                                    <span class="flex items-center w-full gap-2">
                                        <label
                                            class="mb-0 text-xs text-center w-12 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex">@lang('messages.t_4_stars')</label>
                                        <progress max="100"
                                            value="{{ $user_rating['stars_4'] * 100 / $user_rating['total'] }}"
                                            class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400">{{ $user_rating['stars_4'] * 100 / $user_rating['total'] }}%</progress>
                                        <span
                                            class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300">{{ $user_rating['stars_4'] }}</span>
                                    </span>

                                    {{-- 3 star --}}
                                    <span class="flex items-center w-full gap-2">
                                        <label
                                            class="mb-0 text-xs text-center w-12 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex">@lang('messages.t_3_stars')</label>
                                        <progress max="100"
                                            value="{{ $user_rating['stars_3'] * 100 / $user_rating['total'] }}"
                                            class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400">{{ $user_rating['stars_3'] * 100 / $user_rating['total'] }}%</progress>
                                        <span
                                            class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300">{{ $user_rating['stars_3'] }}</span>
                                    </span>

                                    {{-- 2 star --}}
                                    <span class="flex items-center w-full gap-2">
                                        <label
                                            class="mb-0 text-xs text-center w-12 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex">@lang('messages.t_2_stars')</label>
                                        <progress max="100"
                                            value="{{ $user_rating['stars_2'] * 100 / $user_rating['total'] }}"
                                            class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400">{{ $user_rating['stars_2'] * 100 / $user_rating['total'] }}%</progress>
                                        <span
                                            class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300">{{ $user_rating['stars_2'] }}</span>
                                    </span>

                                    {{-- 1 star --}}
                                    <span class="flex items-center w-full gap-2">
                                        <label
                                            class="mb-0 text-xs text-center w-12 shrink-0 text-slate-500 dark:text-zinc-400 whitespace-nowrap flex">@lang('messages.t_1_star')</label>
                                        <progress max="100"
                                            value="{{ $user_rating['stars_1'] * 100 / $user_rating['total'] }}"
                                            class="block h-3 w-full overflow-hidden rounded bg-slate-100 dark:bg-zinc-700 [&::-webkit-progress-bar]:bg-slate-100 dark:[&::-webkit-progress-bar]:bg-zinc-700 [&::-webkit-progress-value]:bg-amber-400 [&::-moz-progress-bar]:bg-amber-400">{{ $user_rating['stars_1'] * 100 / $user_rating['total'] }}%</progress>
                                        <span
                                            class="text-xs font-bold w-9 text-slate-700 dark:text-zinc-300">{{ $user_rating['stars_1'] }}</span>
                                    </span>
                ...
                <div
                    ...
                    @if ($user->description)
                        <section class="px-7">
                            ...
                            <div class="mb-3" id="about-me-element">
                                <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100">
                                    @lang('messages.t_about_me')</h1>
                            </div>

                            {{-- Section body --}}
                            <div class="text-sm text-gray-500 dark:text-zinc-400 leading-relaxed {{ $enable_more_less ? 'max-h-16 overflow-hidden' : '' }}"
                            ...
                            @if ($enable_more_less)
                                ...
                                <div class="mt-4 text-sm font-semibold lowercase text-primary-600 hover:underline cursor-pointer inline-block"
                                    id="profile-description-action-show-more">@lang('messages.t_more')</div>

                                {{-- Show less --}}
                                <div class="mt-4 text-sm font-semibold lowercase text-primary-600 hover:underline cursor-pointer"
                                    id="profile-description-action-show-less" style="display: none">@lang('messages.t_less')
                                </div>
                    ...
                    @if (count($projects))
                        <section class="px-7 pt-8">
                            ...
                            @if (count($projects) > 6)
                                <div class="mt-6">
                                    <a href="{{ url('profile/' . $user->username . '/portfolio') }}"
                    ...
                    @if ($user->skills && $user->skills()->count())
                        <section class="px-7 pt-8">
                            ...
                            <div class="mb-3">
                                <h1 class="text-base font-extrabold text-zinc-800 tracking-wide dark:text-zinc-100">
                                    @lang('messages.t_skills')</h1>
                            </div>

                            {{-- Section body --}}
                            <div class="text-sm text-gray-500 leading-relaxed">
                                @foreach ($user->skills as $skill)
                                    <a href="{{ url('hire', $skill->slug) }}"
                                        ...
                                        @if ($skill->experience === 'beginner')
                                            <svg data-tooltip-target="tooltip-profile-skill-experience-{{ $skill->id }}"
                                            ...
                                            <x-forms.tooltip id="tooltip-profile-skill-experience-{{ $skill->id }}"
                                                :text="__('messages.t_beginner')" />
                                        @elseif ($skill->experience === 'intermediate')
                                            ...
                                            <x-forms.tooltip id="tooltip-profile-skill-experience-{{ $skill->id }}"
                                                :text="__('messages.t_intermediate')" />
                                        @else
                                            <svg data-tooltip-target="tooltip-profile-skill-experience-{{ $skill->id }}"
                    ...
                    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                        ...
                        <div class="col-span-12">
                            <x-forms.textarea :label="__('messages.t_reason')"
                                :placeholder="__('messages.t_report_user_reason_placeholder')" model="reason"
        ...
        @auth
            @if (settings('publish')->enable_custom_offers && $user->account_type === 'seller')
                <x-forms.modal id="modal-send-custom-offer-container" target="modal-send-custom-offer-button"
                        ...
                        <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                            ...
                            @if (settings('publish')->custom_offer_enable_attachments)
                                ...
                                <div class="col-span-12" wire:ignore wire:key='attachments-uploader-form'>
                                    <x-forms.attachments-form :label="__('messages.t_drag_attachments_here')" model="attachments"
                                        id="uploader_attachments" :extensions="explode(',', settings('publish')->custom_offer_attachments_allowed_extensions)"
                                    ...
                                    <div class="p-4 md:p-5 rounded text-slate-700 bg-slate-50">
                                        ...
                                        <ul class="list-inside ltr:ml-8 rtl:mr-8 space-y-2">
                                            ...
                                            <li class="flex items-center text-[13px] tracking-wide">
                                                ...
                                                @lang('messages.t_acceptable_file_types_are') &nbsp;
                                                <b>{{ str_replace(',', ' | ', settings('publish')->custom_offer_attachments_allowed_extensions) }}</b>
                                            </li>
                                            ...
                                            <li class="flex items-center text-[13px] tracking-wide">
                                                ...
                                                @lang('messages.t_the_max_allowable_file_size_is') &nbsp;
                                                <b>{{ settings('publish')->custom_offer_attachment_max_size }}
                                                    @lang('messages.t_size_mb')</b>
                                            </li>
                                            ...
                                            <li class="flex items-center text-[13px] tracking-wide">
                                                ...
                                                @lang('messages.t_u_can_upload_max_files') &nbsp;
                                                <b>{{ settings('publish')->custom_offer_attachment_max_files }}</b>
                                            </li>
                            ...
                            <div class="col-span-12">
                                ...
                                {{-- Label --}}
                                <h3
                                    class="mb-4 text-sm font-medium tracking-wide {{ $errors->first('expected_duration') ? 'text-red-600 dark:text-red-500' : 'text-gray-600 dark:text-white' }}">
                                    @lang('messages.t_expected_duration')</h3>
                                    ...
                                    <li>
                                        <div class="relative">
                                            ...
                                            <input type="number" min="1" max="365" maxlength="3" id="expected-duration-other"
                                                ...
                                                placeholder="@lang('messages.t_other')"
                                ...
                                @error('expected_duration')
                                    <p class="mt-2 text-xs text-red-600 dark:text-red-500">{{ $errors->first('expected_duration') }}
                                    </p>
                                @enderror
                            ...
                            {{-- Budget --}}
                            <div class="col-span-12">
                                <x-forms.text-input :label="__('messages.t_budget')" placeholder="0.00" model="budget"
        ...
        {{-- Share profile --}}
        <x-forms.modal id="modal-share-profile-container" target="modal-share-profile-button" uid="modal_share_profile"
            placement="center-center" size="max-w-md">
            <x-slot name="content">
                    ...
                    <div class="flex flex-col items-center px-4">
                        ...
                        <div class="sharing-buttons flex flex-wrap -mx-1 justify-center mt-2">
                            ...
                            <a class="bg-[#4267B2] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8"
                                ...
                                href="https://facebook.com/sharer/sharer.php?u={{ url('profile', $user->username) }}"
                            ...
                            <a class="bg-[#1DA1F2] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8"
                                target="_blank" rel="noopener"
                                href="https://twitter.com/intent/tweet?url={{ url('profile', $user->username) }}&amp;text={{ $user->fullname ? $user->fullname : $user->username }}"
                            ...
                            <a class="bg-[#0072b1] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8"
                                target="_blank" rel="noopener"
                                href="https://www.linkedin.com/shareArticle?mini=true&amp;url={{ url('profile', $user->username) }}&amp;title={{ $user->fullname ? $user->fullname : $user->username }}&amp;summary={{ $user->fullname ? $user->fullname : $user->username }}&amp;source={{ url('profile', $user->username) }}"
                            ...
                            <a class="bg-[#34526f] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8"
                                target="_blank" rel="noopener"
                                href="https://www.tumblr.com/widgets/share/tool?posttype=link&amp;title={{ $user->fullname ? $user->fullname : $user->username }}&amp;caption={{ $user->fullname ? $user->fullname : $user->username }}&amp;content={{ url('profile', $user->username) }}&amp;canonicalUrl={{ url('profile', $user->username) }}&amp;shareSource=tumblr_share_button"
                            ...
                            <a class="bg-[#E60023] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8"
                                target="_blank" rel="noopener"
                                href="https://pinterest.com/pin/create/button/?url={{ url('profile', $user->username) }}&amp;media={{ url('profile', $user->username) }}&amp;description={{ $user->fullname ? $user->fullname : $user->username }}"
                            ...
                            <a class="bg-[#FF5700] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8"
                                target="_blank" rel="noopener"
                                href="https://reddit.com/submit/?url={{ url('profile', $user->username) }}&amp;resubmit=true&amp;title={{ $user->fullname ? $user->fullname : $user->username }}"
                            ...
                            <a class="bg-[#126567] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8"
                                target="_blank" rel="noopener"
                                href="https://www.xing.com/app/user?op=share;url={{ url('profile', $user->username) }};title={{ $user->fullname ? $user->fullname : $user->username }}"
                            ...
                            <a class="bg-[#128C7E] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8"
                                target="_blank" rel="noopener"
                                href="https://wa.me/?text={{ $user->fullname ? $user->fullname : $user->username }}%20{{ url('profile', $user->username) }}"
                            ...
                            <a class="bg-[#4C75A3] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8"
                                target="_blank" rel="noopener"
                                href="http://vk.com/share.php?title={{ $user->fullname ? $user->fullname : $user->username }}&amp;url={{ url('profile', $user->username) }}"
                            ...
                            <a class="bg-[#229ED9] duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8"
                                target="_blank" rel="noopener"
                                href="https://telegram.me/share/url?text={{ $user->fullname ? $user->fullname : $user->username }}&amp;url={{ url('profile', $user->username) }}"
                            ...
                            <a class="bg-zinc-600 duration-200 ease flex h-8 hover:bg-opacity-80 items-center justify-center m-1 rounded text-white transition w-8"
                                target="_blank" rel="noopener"
                                href="mailto:?subject={{ $user->fullname ? $user->fullname : $user->username }}&amp;body={{ url('profile', $user->username) }}"
