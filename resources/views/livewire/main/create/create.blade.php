<div class="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 mt-[7rem] py-12 lg:pt-16 lg:pb-24">
    <div class="w-full sm:mx-auto sm:max-w-2xl">
        ...
        @if ($isFinished)
            ...
            <div
                class="bg-white dark:bg-zinc-800 justify-center pb-4 pt-5 px-4 rounded-md shadow-sm sm:align-middle sm:max-w-sm sm:p-6 sm:w-full mx-auto">
                <div>
                    <div
                        class="mx-auto flex items-center justify-center h-12 w-12 rounded-full bg-green-100 dark:bg-zinc-700">
                    ...
                    <div class="mt-3 text-center sm:mt-5">
                        <h3 class="text-md leading-6 font-medium text-gray-900 dark:text-gray-200" id="modal-title">
                            {{ __('messages.t_gig_created') }}</h3>
                        <div class="mt-2">
                            @if ($is_approved)
                                <p class="text-sm text-gray-500 dark:text-gray-400">{{ __('messages.t_gig_created_subtitle') }}
                                </p>
                            @else
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    {{ __('messages.t_gig_created_subtitle_pending_approval') }}</p>
                            @endif
                        </div>
                    </div>
                </div>
        ...
        @else
            ...
            <div class="card px-4 py-10 sm:p-10 md:mx-0 mb-6">
                ...
                {{-- Section head --}}
                <div
                    class="flex-col md:flex-row md:justify-between flex md:items-center gap-4 border-b pb-6 border-slate-100 dark:border-zinc-700 mb-8">

                    {{-- Title --}}
                    <div class="flex items-center gap-x-4">
                        <div
                            class="bg-slate-100 flex h-14 items-center justify-center rounded-full shrink-0 text-2xl text-slate-500 w-14 dark:bg-zinc-700 dark:text-zinc-400">
                    ...
                    <div class="md:ms-auto flex items-center gap-2">
                        ...
                        <button id="modal-upgrade-seo-button" type="button"
                            ...
                            <i
                                class="ph-duotone ph-magnifying-glass w-4 h-4 flex items-center justify-center text-lg text-gray-400 dark:text-zinc-400"></i>
                ...
                <div class="w-full new-service-container">
                    <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                        ...
                        <div class="col-span-12">
                            <x-forms.gig-title required model="title" :label="__('messages.t_service_title')" />
                        </div>
                        ...
                        <div class="col-span-12" wire:key="create-service-subcategories">
                            <x-forms.select-simple required live model="subcategory" :label="__('messages.t_subcategory')"
                        ...
                        <div class="col-span-12" wire:key="create-service-childcategories">
                            <x-forms.select-simple required model="childcategory" :label="__('messages.t_childcategory')"
                        ...
                        <div class="col-span-12" wire:key="create-service-description" wire:ingore>
                            <x-forms.ckeditor required :label="__('messages.t_description')"
                                :placeholder="__('messages.t_briefly_describe_ur_gig')" model="description"
                                target="create-gig-action-btn" />
                        </div>

                        {{-- Search tags --}}
                        <div class="col-span-12">
                            <x-forms.tags-input required :label="__('messages.t_search_tags')"
                                :placeholder="__('messages.t_press_enter_to_add_tags')" model="tags" :tags="$tags" />
                        </div>
            ...
            <div class="card px-4 py-10 sm:p-10 md:mx-0 mb-6">
                ...
                <div
                    ...
                    <div class="md:ms-auto flex items-center gap-2">
                        ...
                        {{-- Add faq --}}
                        <button id="modal-add-faq-button" type="button"
                            class="inline-flex justify-center items-center space-x-2 rtl:space-x-reverse rounded border font-semibold focus:outline-none px-3 py-2 leading-5 whitespace-nowrap text-xs border-gray-300 bg-white text-gray-700 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none tracking-wide dark:bg-zinc-700 dark:border-zinc-600 dark:text-zinc-300 dark:hover:text-zinc-200">
                            <i
                                class="ph-duotone ph-folder-simple-plus w-4 h-4 flex items-center justify-center text-lg text-gray-400 dark:text-zinc-400"></i>
                                        ...
                                        <details class="px-6 py-4 rounded-lg bg-gray-50 dark:bg-zinc-700 group relative"
                                            ...
                                            <summary class="flex items-center justify-between cursor-pointer focus:outline-none">
                                                ...
                                                <h5
                                                    ...
                                                    {{ $faq['question'] }}
                                                    <button type="button" wire:click="removeFaq({{ $key }})"
            ...
            <div class="card px-4 py-10 sm:p-10 md:mx-0 mb-6">
                ...
                <div
                    ...
                    <div class="md:ms-auto flex items-center gap-2">
                        ...
                        {{-- Add faq --}}
                        <button id="modal-add-upgrade-button" type="button"
                            class="inline-flex justify-center items-center space-x-2 rtl:space-x-reverse rounded border font-semibold focus:outline-none px-3 py-2 leading-5 whitespace-nowrap text-xs border-gray-300 bg-white text-gray-700 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none tracking-wide dark:bg-zinc-700 dark:border-zinc-600 dark:text-zinc-300 dark:hover:text-zinc-200">
                            <i
                                class="ph-duotone ph-folder-simple-plus w-4 h-4 flex items-center justify-center text-lg text-gray-400 dark:text-zinc-400"></i>
                ...
                <div class="w-full new-service-container">
                    <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                        ...
                        <div class="col-span-12 md:col-span-6">
                            <x-forms.text-input required :label="__('messages.t_price')" placeholder="0.00" model="price"
                                suffix="{{ $currency_symbol }}" />
                        </div>

                        {{-- Delivery time --}}
                        <div class="col-span-12 md:col-span-6" wire:key="create-service-available-deliveries">
                            <x-forms.select-simple required model="delivery_time" :label="__('messages.t_delivery_time')"
                ...
                @forelse ($upgrades as $key => $upgrade)
                    <div class="{{ $loop->first ? 'mt-10' : '' }} mb-6 bg-white dark:bg-zinc-800 shadow-sm rounded-md border border-gray-200 dark:border-zinc-700"
                        id="scroll-to-upgrade-id-{{ $key }}" wire:key="create-gig-pricing-upgrade-id-{{ $key }}">

                        {{-- Upgrade title --}}
                        <div class="bg-gray-50 dark:bg-zinc-700 px-8 py-4 rounded-t-md">
                            <div class="-ml-4 -mt-4 flex justify-between items-center flex-wrap sm:flex-nowrap">
                                <div class="ltr:ml-4 rtl:mr-4 mt-4">
                                    <h3 class="text-sm leading-6 font-bold tracking-wide text-gray-900 dark:text-gray-100">
                                        {{ __('messages.t_upgrade_number', ['number' => $key + 1]) }}</h3>
                                ...
                                <div class="ltr:ml-4 rtl:mr-4 flex-shrink-0 mt-4">
                                    <button wire:click="removeUpgrade({{ $key }})"
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            class="h-4 w-4 text-red-500 hover:text-red-600 mr-2" fill="none" viewBox="0 0 24 24"
                                            stroke="currentColor" stroke-width="2">
                                            <path stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 px-8 py-6">
                            ...
                            <div class="col-span-12" wire:key="{{ uid() }}">
                                <x-forms.text-input required label="{{ __('messages.t_upgrade_title') }}"
                                    placeholder="{{ __('messages.t_enter_upgrade_title') }}" model="upgrades.{{ $key }}.title"
                                    icon="cursor-text" />
                            </div>

                            {{-- Upgrade price --}}
                            <div class="col-span-12 md:col-span-6" wire:key="{{ uid() }}">
                                <x-forms.text-input required label="{{ __('messages.t_price') }}" :placeholder="0.00"
                                    model="upgrades.{{ $key }}.price" suffix="{{ $currency_symbol }}" />
                            </div>

                            {{-- Delivery time --}}
                            <div class="col-span-12 md:col-span-6" wire:key="{{ uid() }}">
                                <x-forms.select-simple required model="upgrades.{{ $key }}.extra_days"
            ...
            <div class="card px-4 py-10 sm:p-10 md:mx-0 mb-6">
                ...
                <div
                    ...
                    <div class="md:ms-auto flex items-center gap-2">
                        ...
                        {{-- Add requirement --}}
                        <button id="modal-add-requirement-button" type="button"
                            class="inline-flex justify-center items-center space-x-2 rtl:space-x-reverse rounded border font-semibold focus:outline-none px-3 py-2 leading-5 whitespace-nowrap text-xs border-gray-300 bg-white text-gray-700 shadow-sm hover:text-gray-800 hover:bg-gray-100 hover:border-gray-300 hover:shadow focus:ring focus:ring-gray-500 focus:ring-opacity-25 active:bg-white active:border-white active:shadow-none tracking-wide dark:bg-zinc-700 dark:border-zinc-600 dark:text-zinc-300 dark:hover:text-zinc-200">
                            <i
                                class="ph-duotone ph-folder-simple-plus w-4 h-4 flex items-center justify-center text-lg text-gray-400 dark:text-zinc-400"></i>
                                        ...
                                        @foreach ($requirements as $key => $req)
                                            <li wire:key="create-gig-requirement-item-{{ $key }}">
                                                <div class="relative {{ !$loop->last ? 'pb-12' : '' }}">
                                                    @if (!$loop->last)
                                                        <span
                                                            class="absolute top-4 left-6 -ml-px h-full w-0.5 bg-gray-200 dark:bg-zinc-700"
                                                            aria-hidden="true"></span>
                                                    @endif
                                                    <div class="relative flex space-x-3 rtl:space-x-reverse">
                                                        <div>
                                                            <span
                                                                class="h-12 w-12 rounded-full bg-gray-200 dark:bg-zinc-700 flex items-center justify-center ring-8 ring-white dark:ring-zinc-800">

                                                                @if ($req['type'] === 'text')
                                                                    <svg xmlns="http://www.w3.org/2000/svg"
                                                                        class="h-5 w-5 text-gray-800 dark:text-gray-300" fill="none"
                                                        ...
                                                        <div
                                                            class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4 rtl:space-x-reverse">
                                                            <div>
                                                                ...
                                                                <div
                                                                    class="mt-1 flex flex-col sm:flex-row sm:flex-wrap sm:mt-0 sm:space-x-6 rtl:space-x-reverse">
                                                                    ...
                                                                    {{-- Edit --}}
                                                                    <div wire:click="editRequirement({{ $key }})"
                                                                        class="mt-2 flex items-center text-xs text-gray-400 cursor-pointer">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            class="flex-shrink-0 mr-1.5 h-4 w-4 text-gray-400"
                                                                            fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                                                            stroke-width="2">
                                                                    ...
                                                                    {{-- Delete --}}
                                                                    <div wire:click="deleteRequirement({{ $key }})"
                                                                        class="mt-2 flex items-center text-xs text-red-600 cursor-pointer">
                                                                        <svg xmlns="http://www.w3.org/2000/svg"
                                                                            class="flex-shrink-0 mr-1.5 h-4 w-4 text-red-600"
                                                                            fill="none" viewBox="0 0 24 24" stroke="currentColor"
                                                                            stroke-width="2">
                                                                            <path stroke-linecap="round" stroke-linejoin="round"
                                                                                d="M19 7l-.867 12.142A2 2 0 0116.138 21H7.862a2 2 0 01-1.995-1.858L5 7m5 4v6m4-6v6m1-10V4a1 1 0 00-1-1h-4a1 1 0 00-1 1v3M4 7h16" />
                    ...
                    <div class="grid grid-cols-12 md:gap-x-8 gap-y-8 mb-6">
                        ...
                        <div class="col-span-12 mb-10">
                            ...
                            <div class="w-full" wire:ignore>
                                ...
                                {{-- Label --}}
                                <div
                                    class="block text-xs font-bold tracking-wide whitespace-nowrap overflow-hidden truncate text-zinc-500 dark:text-white mb-2.5">
                                ...
                                {{-- Uploader --}}
                                <x-forms.uploader model="thumbnail" id="uploader_thumbnail" :extensions="['jpg', 'jpeg', 'png']" accept="image/jpg, image/jpeg, image/png"
                                    size="{{ settings('publish')->max_image_size }}" max="1" />
                            ...
                            @if($errors->has('images.*'))
                                <div class="mt-2 p-4 md:p-5 rounded text-red-700 bg-red-100">
                                    <div class="flex items-center mb-3">
                                        <svg class="inline-block w-5 h-5 ltr:mr-3 rtl:ml-3 flex-none text-red-500"
                                        ...
                                        @foreach($errors->get('images.*') as $errors)
                                            @foreach($errors as $error)
                                                <li class="flex items-center text-xs font-semibold">
                                                    <svg class="inline-block w-4 h-4 flex-none ltr:mr-2 rtl:ml-2 rtl:rotate-180"
                                                        fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                                        <path fill-rule="evenodd"
            ...
            {{-- SEO Modal --}}
            <x-forms.modal id="modal-upgrade-seo-container" target="modal-upgrade-seo-button" uid="modal_uid_{{ uid() }}"
                                    ...
                                    <div
                                        ...
                                        <div class="mt-2 flex items-center text-sm text-gray-500">
                                            ...
                                            <div class="text-xs font-normal text-gray-400 ml-2">
                                                ...
                                                {{ strtolower(__('messages.t_reviews')) }} <span class="px-1">•</span> $5.00
                                            </div>
            ...
            {{-- FAQ Modal --}}
            <x-forms.modal id="modal-add-faq-container" target="modal-add-faq-button" uid="modal_uid_{{ uid() }}"
                ...
                <x-slot name="content">
                    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                        ...
                        {{-- Question --}}
                        <div class="col-span-12">
                            <x-forms.text-input required :placeholder="__('messages.t_faq_question_example')"
                                model="question" icon="question" />
                        </div>

                        {{-- Answer --}}
                        <div class="col-span-12">
                            <x-forms.textarea required :placeholder="__('messages.t_faq_answer_example')" :rows="7"
                                model="answer" icon="article" />
                        </div>
            ...
            {{-- Upgrade Modal --}}
            <x-forms.modal id="modal-add-upgrade-container" target="modal-add-upgrade-button" uid="modal_uid_{{ uid() }}"
                placement="center-center" size="max-w-md">
                ...
                <x-slot name="content">
                    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                        ...
                        {{-- Upgrade title --}}
                        <div class="col-span-12">
                            <x-forms.text-input required :placeholder="__('messages.t_describe_ur_offering')"
                                model="add_upgrade.title" icon="cursor-text" />
                        </div>

                        {{-- Price --}}
                        <div class="col-span-12">
                            <x-forms.text-input required :placeholder="__('messages.t_for_and_extra_price')"
                                model="add_upgrade.price" suffix="{{ $currency_symbol }}" />
                        </div>

                        {{-- Delivery time --}}
                        <div class="col-span-12" wire:key="create-service-available-deliveries-add-upgrade">
                            <x-forms.select-simple required model="add_upgrade.extra_days"
            ...
            {{-- Requirement Modal --}}
            <x-forms.modal id="modal-add-requirement-container" target="modal-add-requirement-button"
                uid="modal_uid_{{ uid() }}" placement="center-center" size="max-w-2xl">
                    ...
                    <div class="grid grid-cols-12 md:gap-x-6 gap-y-6">
                        ...
                        <div class="col-span-12">
                            <x-forms.textarea required
                                ...
                                model="add_requirement.question" :rows="6" icon="question" />
                        </div>

                        {{-- Type --}}
                        <div class="col-span-12" wire:key="create-service-add-requirement-type">
                            <x-forms.select-simple required live model="add_requirement.type"
                        ...
                        @if (isset($add_requirement['type']) && $add_requirement['type'] === 'choice')
                            ...
                            {{-- Multiple choices --}}
                            <div class="col-span-12">
                                <x-bladewind.toggle :checked="isset($add_requirement['is_multiple']) ? $add_requirement['is_multiple'] : false" name="add_requirement.is_multiple"
                                    :label="__('messages.t_multiple_choices')" label_position="right" />
                            </div>
                            ...
                            @foreach ($add_requirement['options'] as $i => $option)
                                <div class="col-span-12" wire:key="add-requirement-choice-option-id-{{ $i }}">
                                    <div class="flex-grow relative">
                                        <input wire:model.defer="add_requirement.options.{{ $i }}"
                                            ...
                                            type="text" placeholder="{{ __('messages.t_add_option') }}" maxlength="100">
                                        @if (count($add_requirement['options']) > 2)
                                            <div class="absolute inset-y-0 ltr:right-0 rtl:left-0 ltr:pr-3 rtl:pl-3 flex items-center cursor-pointer"
                                                wire:click="deleteOption({{ $i }})">
                                                <span
                                                    class="hover:text-red-500 {{ $errors->first('add_requirement.options.' . $i) ? 'text-red-400' : 'text-gray-400' }}">
                                    ...
                                    @error('add_requirement.options.' . $i)
                                        <p class="mt-1 text-xs text-red-600 dark:text-red-500">
                                            {{ $errors->first('add_requirement.options.' . $i) }}</p>
                                    @enderror
                                </div>
                            @endforeach
                            ...
                            <div class="col-span-6">
                                <button wire:click="addOption" type="button"
                                    class="text-primary-600 hover:text-white hover:bg-primary-600 border-2 border-primary-600 focus:ring-0 focus:outline-none font-medium rounded text-xs px-5 py-2 text-center inline-flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg"
                                        class="w-5 h-5 ltr:mr-2 rtl:ml-2 ltr:-ml-1 rtl:-mr-1" fill="none" viewBox="0 0 24 24"
                                        stroke="currentColor" stroke-width="2">
                ...
                <x-slot name="footer">
                    <div class="flex justify-between w-full">
                        ...
                        <div class="flex items-center">
                            <x-bladewind.toggle :checked="isset($add_requirement['is_required']) ? $add_requirement['is_required'] : false" name="add_requirement.is_required"
                                :label="__('messages.t_required')" label_position="right" />
                        </div>
