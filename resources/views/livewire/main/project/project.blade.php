...
@endphp
                ...
                @if (auth()->user()?->id === $project->user_id)
                    <section
                        ...
                        <div class="mt-5 space-y-4">
                            @foreach ($bestBids as $recommendation)
                                @php
                                        ...
                                        <div class="space-y-2">
                                            ...
                                            <div
                                                ...
                                                <span class="inline-flex items-center gap-1 text-slate-400 dark:text-zinc-500">
                                                    ...
                                                    {{ format_date($bid->created_at, 'ago') }}
                                                </span>
                                            </div>
                                            @if ($bid->message)
                                                <p class="text-[12.5px] leading-6 text-slate-600 dark:text-zinc-300">
                                                    {{ \Illuminate\Support\Str::limit(strip_tags($bid->message), 200) }}
                                                </p>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="flex flex-col items-end gap-2">
                                        <a href="#bid-{{ $recommendation['bid']->uid }}"
                ...
                <section>
                    <article
                        ...
                        <div class="mt-6 space-y-10">
                            ...
                            <section>
                                <h3 class="text-sm font-semibold text-zinc-800 dark:text-zinc-200">
                                    @lang('messages.t_required_skills')
                                </h3>
                                    ...
                                    <div
                                        ...
                                        <div
                                            ...
                                            <h3 class="text-sm font-semibold text-zinc-900 dark:text-zinc-100">
                                                @lang('messages.t_project_brief_questions_heading')
                                            </h3>
                                            <p class="mt-2 text-[13px] leading-6 text-slate-600 dark:text-zinc-400">
                                                @lang('messages.t_project_brief_questions_hint')
                                            </p>
                                        </div>
                                            ...
                                            @foreach ($briefQuestions as $question)
                                                <li class="px-6 py-5 sm:px-8">
                                                    <div
                                                        ...
                                                        <span class="inline-flex items-center rounded-full border px-3 py-1 text-[11px] font-semibold uppercase tracking-wide @class([
                                                            ...
                                                            {{ $question->is_required ? __('messages.t_project_brief_question_required_badge') : __('messages.t_project_brief_question_optional_badge') }}
                                                        </span>
                                                    </div>
                                                </li>
                                            @endforeach
                                    ...
                                    <div
                                        ...
                                        <div class="px-6 py-5 sm:px-8 sm:py-6">
                                            <h3 class="text-sm font-semibold text-primary-800 dark:text-primary-200">
                                                @lang('messages.t_project_nda_heading')
                                            </h3>
                                            <p
                                                class="mt-2 text-[13px] leading-6 text-primary-800/80 dark:text-primary-100/80">
                                                @lang('messages.t_project_nda_public_hint')
                                            </p>
                                            <dl class="mt-4 grid gap-4 sm:grid-cols-2">
                                                <div class="space-y-1">
                                                    <dt
                                                        class="text-[12px] font-bold uppercase tracking-wide text-primary-700/80 dark:text-primary-200/80">
                                                        @lang('messages.t_project_nda_scope_label')
                                                    </dt>
                                                    <dd class="text-sm leading-6 text-primary-900 dark:text-primary-100">
                                                        {{ $project->nda_scope ?: __('messages.t_project_nda_scope_default') }}
                                                    </dd>
                                                </div>
                                                <div class="space-y-1">
                                                    <dt
                                                        class="text-[12px] font-bold uppercase tracking-wide text-primary-700/80 dark:text-primary-200/80">
                                                        @lang('messages.t_project_nda_term_label')
                                                    </dt>
                                                    <dd class="text-sm leading-6 text-primary-900 dark:text-primary-100">
                                                        {{ trans_choice('messages.t_project_nda_term_value', $project->nda_term_months ?? 12, ['count' => $project->nda_term_months ?? 12]) }}
                                                    </dd>
                                                </div>
                                            </dl>
                                        </div>
                            ...
                            @if ($project->status === 'active')
                                <div
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h3 class="font-semibold">@lang('messages.t_beware_of_scams')</h3>
                                            <p class="mt-1 text-[13px] leading-6">
                                                @lang('messages.t_beware_of_scams_details')
                                            </p>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @if ($project->status === 'closed')
                        <div
                            ...
                            <h2 class="mt-5 block text-sm font-semibold text-zinc-800">
                                @lang('messages.t_this_project_is_closed_for_bidding')
                            </h2>
            ...
            <section class="lg:col-start-3 lg:col-span-1">
                ...
                <div
                    ...
                    <div class="mt-4 space-y-3 text-sm text-slate-600 dark:text-zinc-200">
                        <div class="flex items-center justify-between gap-3">
                            <span>@lang('messages.t_budget')</span>
                            <span class="font-semibold text-zinc-900 dark:text-zinc-100">{{ $projectBudget }}</span>
                        </div>
                        <div class="flex items-center justify-between gap-3">
                            <span>@lang('messages.t_budget_type')</span>
                        ...
                        <div class="flex items-center justify-between gap-3">
                            <span>@lang('messages.t_category')</span>
                            <span
                                class="font-semibold text-zinc-900 dark:text-zinc-100">{{ $projectCategory ?? __('messages.t_na') }}</span>
                        </div>
                        <div class="flex items-center justify-between gap-3">
                            <span>@lang('messages.t_status')</span>
                            <span
                                class="inline-flex items-center gap-2 rounded-full px-3 py-1 text-[12px] font-semibold {{ $projectStatusClass }}">
                        ...
                        <div class="flex items-center justify-between gap-3">
                            ...
                            <span
                                class="font-semibold text-zinc-900 dark:text-zinc-100">{{ number_format($projectBidsCount) }}</span>
                        </div>
                        <div class="flex items-center justify-between gap-3">
                            <span>@lang('messages.t_avg_bid')</span>
                            <span class="font-semibold text-zinc-900 dark:text-zinc-100">{{ $projectAvgBid }}</span>
                        </div>
                        <div class="flex items-center justify-between gap-3">
                            <span>@lang('messages.t_posted_date')</span>
                            <span
                                class="font-semibold text-zinc-900 dark:text-zinc-100">{{ format_date($project->created_at, 'ago') }}</span>
                        </div>
                        <div class="flex items-center justify-between gap-3">
                            <span>@lang('messages.t_clicks')</span>
                            <span
                                class="font-semibold text-zinc-900 dark:text-zinc-100">{{ number_format($project->counter_views) }}</span>
                        </div>
                        <div class="flex items-center justify-between gap-3">
                            <span>@lang('messages.t_impressions')</span>
                            <span
                                class="font-semibold text-zinc-900 dark:text-zinc-100">{{ number_format($project->counter_impressions) }}</span>
                        </div>
                    </div>
                </div>
                <section class="">
                    <div
                        ...
                        <h3 class="text-sm font-semibold text-zinc-800 dark:text-zinc-100">
                            @lang('messages.t_client_info')
                        </h3>
                        <div class="mt-3 flex items-center gap-3">
                            <img class="h-12 w-12 rounded-xl object-cover shadow-sm" src="{{ placeholder_img() }}"
                            ...
                            <li
                                ...
                                <div>
                                    ...
                                    <p class="text-[12px] text-slate-600 dark:text-zinc-300">
                                        {{ $clientInsights['has_payment_method'] ? 'تم ربط وسيلة دفع جاهزة للدفع السريع.' : 'لم يقم العميل بعد بإضافة وسيلة دفع.' }}
                                    </p>
                                </div>
                            </li>
                            <li
                            ...
                            <li
                                ...
                                <div>
                                    <p class="text-sm font-semibold text-zinc-800 dark:text-zinc-100">
                                        المشاريع المنشورة</p>
                                    <p class="text-[12px] text-slate-600 dark:text-zinc-300">
                                        {{ $projectsTotal }} {{ __('messages.t_projects') }}
                                    </p>
                                </div>
                            </li>
                            <li
                    ...
                    @if (!empty($clientFeedbackSummary['categories']) && ($clientFeedbackSummary['total'] ?? 0) > 0)
                        <div
                            ...
                            <div class="flex flex-wrap items-center justify-between gap-3">
                                <div>
                                    ...
                                    <p class="text-[11.5px] text-slate-400 dark:text-zinc-500">
                                        {{ $clientFeedbackSummary['total'] }} تقييم/ات موثقة.
                                    </p>
                                </div>
                                <span
                                    ...
                                    {{ $clientFeedbackSummary['average'] }}/5
                                </span>
                            </div>
                            <div class="mt-4 space-y-3 text-[12.5px] text-slate-600 dark:text-zinc-300">
                                @foreach ($clientFeedbackSummary['categories'] as $category)
                                    <div
    ...
    @auth
        @if (auth()->id() != $project->user_id && $project->status === 'active' && !$already_submitted_proposal)
            <x-forms.modal id="modal-bid-container" target="modal-bid-button" uid="modal_{{ uid() }}" placement="center-center"
                size="max-w-6xl">
                ...
                <x-slot name="content">
                    ...
                    @if ($bid_current_step === 1)
                        ...
                        <div class="grid grid-cols-12 md:gap-x-6 gap-y-6 py-2">
                            ...
                            @if ($modalBriefQuestions->isNotEmpty())
                                <div class="col-span-12">
                                    <div
                                        ...
                                        <div class="flex flex-col space-y-2">
                                            ...
                                            <p class="text-[13px] leading-6 text-slate-600 dark:text-zinc-300">
                                                @lang('messages.t_project_requirements_block_subtitle')
                                            </p>
                                        </div>
                                        <div class="mt-5 space-y-5">
                                            @foreach ($modalBriefQuestions as $question)
                                                <div class="space-y-2">
                                                    <label for="bid-brief-question-{{ $loop->iteration }}"
                                                        ...
                                                        <span class="rounded-full border px-3 py-1 text-[11px] font-semibold uppercase tracking-wide @class([
                                                    ...
                                                    <textarea wire:model.defer="brief_responses.{{ $question->uid }}"
                                                        id="bid-brief-question-{{ $loop->iteration }}" rows="3"
                                                        ...
                                                        placeholder="{{ __('messages.t_project_brief_question_placeholder') }}"></textarea>
                                                    @error('brief_responses.' . $question->uid)
                                    ...
                                    <div
                                        ...
                                        <div class="flex flex-col space-y-2">
                                            ...
                                            <p class="text-[13px] leading-6 text-primary-800/80 dark:text-primary-100/70">
                                                @lang('messages.t_project_nda_modal_hint')
                                            </p>
                                        </div>
                                        <div class="mt-5 space-y-4">
                                            <label
                                                ...
                                                <span>@lang('messages.t_project_nda_checkbox_label')</span>
                                            </label>
                                            @error('nda_confirmed')
                                                <p class="text-[12px] font-medium text-red-600 ltr:pl-1 rtl:pr-1">
                                                    {{ $message }}
                                            ...
                                            <div class="space-y-2">
                                                <label for="nda-signature-input"
                                                    ...
                                                    @lang('messages.t_project_nda_signature_label')
                                                </label>
                                                <input type="text" id="nda-signature-input" wire:model.defer="nda_signature"
                                                    placeholder="{{ __('messages.t_project_nda_signature_placeholder') }}"
                            ...
                            @if (!$isHourlyProject)
                                ...
                                <div class="grid gap-3 md:grid-cols-2">
                                    ...
                                    <label wire:click="$set('bid_plan_type', 'milestone')" @class([
                                        'flex cursor-pointer items-start gap-3 rounded-2xl border px-4 py-3 transition hover:border-primary-200 hover:bg-primary-50/40 dark:border-zinc-600 dark:hover:border-primary-400 dark:hover:bg-primary-500/10',
                                ...
                                @if ($bid_plan_type === 'milestone')
                                    ...
                                    @foreach ($bid_milestones as $index => $milestone)
                                        <div
                                            ...
                                            <div class="flex flex-col gap-3 md:flex-row md:items-center md:justify-between">
                                                ...
                                                @if ($index > 0)
                                                    <button type="button" wire:click="removeBidMilestone({{ $index }})"
                                            ...
                                            <div class="mt-3 grid gap-3 md:grid-cols-3">
                                                <div class="md:col-span-2">
                                                    ...
                                                    <input type="text" wire:model.defer="bid_milestones.{{ $index }}.title"
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" wire:model.defer="bid_milestones.{{ $index }}.amount"
                                                        class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-700 focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-100 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100"
                                                        placeholder="{{ __('messages.t_amount') }}">
                                                </div>
                                                <div>
                                                    <label
                                                        class="mb-1 block text-[12px] font-semibold text-slate-500 dark:text-zinc-300">التسليم
                                                        خلال</label>
                                                    <input type="text" wire:model.defer="bid_milestones.{{ $index }}.due_in"
                                                        class="w-full rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-700 focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-100 dark:border-zinc-600 dark:bg-zinc-800 dark:text-zinc-100"
                                    ...
                                    <div class="relative flex items-center w-full py-4">
                                        <div class="flex items-center h-5">
                                            <input id="bid-promotion-plan-{{ $plan->uid }}" name="bidding_selected_plans"
                                                wire:model.defer="bid_{{ $plan->plan_type }}" value="{{ $plan->uid }}" type="checkbox"
