<div class="max-w-[1500px] mx-auto px-4 sm:px-6 lg:px-8 mt-[7rem] py-12 lg:pt-16 lg:pb-24">
    ...
    <div
        class="bg-white dark:bg-zinc-800 sm:max-w-md sm:w-full sm:mx-auto sm:rounded-lg sm:overflow-hidden shadow-sm border dark:border-zinc-700">
        <div class="">
        ...
        {{-- Footer --}}
        <div
            class="px-4 py-6 bg-gray-50 dark:bg-zinc-700 border-t-2 border-gray-200 dark:border-zinc-700 sm:px-6 text-center">
            <a href="{{ url('auth/login') }}"
                class="text-xs leading-5 text-gray-600 dark:text-gray-300 flex items-center justify-center">
