...
return [
    ...
    "t_free_plan_monthly_proposals"                            => "Free plan monthly proposals",
    "t_enter_free_plan_monthly_proposals"                      => "Enter the number of proposals included each month",
    "t_free_plan_monthly_proposals_hint"                       => "Set to 0 to allow unlimited proposals on the free plan.",
    ...
    "t_welcome"                                                => "Welcome",
    "t_regards"                                                => "Regards",
    "t_if_u_have_trouble_click_link_notification"              => "If you are having trouble clicking the :actionText button, copy and paste the URL belown into your web browser:",
    ...
    "t_hourly_projects_coming_soon"                            => "Hourly projects will be available soon. Please choose a fixed price budget for now.",
    "t_hourly_projects_edit_notice"                            => "Existing hourly projects were switched to fixed price while we finish the hourly experience. Review your budget before saving.",
    ...
    "t_bid_milestones_required"                               => "Add at least one milestone with title, amount, and delivery time.",
    "t_error"                                                  => "Error",
    ...
    "t_login_subtitle_modern"                                  => "Access your personalised workspace on :app in seconds.",
    "t_register_intro_modern"                                  => "Tell us how you plan to use the platform and we will prepare the right experience for you.",
    "t_register_step_choose_role"                              => "Choose role",
    "t_register_step_account"                                  => "Account details",
    "t_theme_light"                                            => "Light mode",
    "t_theme_dark"                                             => "Dark mode",
    "t_theme_system"                                           => "Match system",
    "t_theme_toggle"                                           => "Toggle theme",
    "t_reset_all"                                              => "Reset all",
    "t_post_step_intro_title"                                  => "Idea & Goals",
    "t_post_step_intro_caption"                                => "Describe the outcome, audience, and critical questions.",
    "t_post_step_team_title"                                   => "Team & Requirements",
    "t_post_step_team_caption"                                 => "Pick the skills and share supporting assets.",
    "t_post_step_budget_title"                                 => "Budget & Launch",
    "t_post_step_budget_caption"                               => "Lock the price range and visibility options.",
    "t_post_step_preview_title"                                => "Review & Launch",
    "t_post_step_preview_caption"                              => "Double-check details before the project goes live.",
    "t_post_summary_heading"                                   => "Project Snapshot",
    "t_post_summary_title"                                     => "Title",
    "t_post_summary_category"                                  => "Category",
    "t_post_summary_description"                               => "Description",
    "t_post_summary_budget"                                    => "Budget",
    "t_post_summary_nda"                                       => "NDA",
    "t_post_summary_nda_yes"                                   => "Required",
    "t_post_summary_nda_no"                                    => "Not required",
    "t_post_summary_skills"                                    => "Selected Skills",
    "t_post_summary_no_skills"                                 => "No skills chosen yet.",
    "t_choose_how_you_will_use_app"                            => "How will you use :app?",
    "t_role_selection_help"                                    => "Pick the option that fits you best. You can always adjust your workflow later from settings.",
    "t_role_freelancer_title"                                  => "I am a freelancer",
    "t_role_freelancer_desc"                                   => "Showcase your skills, apply to projects, and organise deliverables with smart milestones.",
    "t_role_freelancer_badge"                                  => "Build & deliver",
    "t_role_client_title"                                      => "I am a client",
    "t_role_client_desc"                                       => "Publish projects effortlessly, compare proposals, and hire verified talent with confidence.",
    "t_role_client_badge"                                      => "Hire talent",
    "t_role_hybrid_title"                                      => "Both freelancer & client",
    "t_role_hybrid_desc"                                       => "Switch seamlessly between hiring and working. Post projects today and activate your freelancer tools any time.",
    "t_role_hybrid_badge"                                      => "Flexible workflow",
    "t_select_role_cta"                                        => "Select this role",
    "t_clear_choice"                                           => "Clear choice",
    "t_role_label_freelancer"                                  => "Freelancer plan",
    "t_role_label_client"                                      => "Client plan",
    "t_role_label_hybrid"                                      => "Hybrid plan",
    "t_setup_your_profile"                                     => "Let’s set up your profile details",
    "t_account_details_subheading"                             => "Add your contact information. We will use it to secure and personalise your workspace.",
    "t_select_role_first"                                      => "Please choose how you would like to use the platform first.",
    ...
    "t_delete_project_admin_alert"                             => "Please remember that anything related to this project will be erased, including bids, subscriptions, milestones... n Make sure to delete only new projects, that has nothing yet. n This action cannot be undone.",
    ...
    "t_portfolio_progress_title"                               => "Show clients what you can do",
    "t_portfolio_progress_subtitle"                            => "Add at least :count portfolio projects to unlock full bidding power on تعاقد.",
    "t_portfolio_progress_completed_badge"                     => "Requirement met",
    "t_portfolio_progress_missing_badge"                       => ":count more to unlock bidding",
    "t_portfolio_metric_total"                                 => "Total projects",
    "t_portfolio_metric_active"                                => "Published",
    "t_portfolio_metric_pending"                               => "Awaiting review",
    "t_portfolio_metric_views"                                 => "Unique visits",
    "t_portfolio_metric_likes"                                 => "Project loves",
    "t_portfolio_showcase"                                     => "Latest work",
    "t_add_portfolio_item"                                     => "Upload a new project",
    "t_add_portfolio_item_hint"                                => "Share case studies, redesigns, or shipped products that highlight your strengths.",
    "t_portfolio_empty_title"                                  => "Let’s create your first portfolio entry",
    "t_portfolio_empty_subtitle"                               => "Clients hire faster when they can explore real examples of your work. Add your first project now.",
    "t_portfolio_pending_badge"                                => ":count waiting for approval",
    "t_login_required"                                         => "Login required",
    "t_login_to_love_project"                                  => "Please log in to save this project to your favorites.",
    "t_action_not_allowed"                                     => "Action not allowed",
    "t_cannot_love_own_project"                                => "You cannot add your own project to favorites.",
    "t_reviews_received_title"                                 => "Client feedback spotlight",
    "t_reviews_received_subtitle"                              => "See what clients shared after collaborating with you on تعاقد.",
    "t_average_rating"                                         => "Average rating",
    "t_rating_breakdown"                                       => "Rating breakdown",
    "t_review_without_comment"                                 => "The client left a rating without a written comment.",
    "t_no_reviews_yet"                                         => "No reviews yet",
    "t_no_reviews_yet_subtitle"                                => "Once you complete a project, client feedback will appear here automatically.",
    ...
    "t_monthly_proposals_progress_label"                       => "Monthly proposals",
    "t_monthly_proposals_remaining"                            => "Remaining",
    "t_monthly_proposals_reset"                                => "Renews on :date",
    "t_monthly_proposals_keep_bidding"                         => "Keep sending tailored proposals to stand out.",
    "t_free_plan_limit_reached_title"                          => "Free plan limit reached",
    "t_free_plan_limit_reached_body"                           => "You have used all :count proposals included in the free plan this month. Upgrade your plan or wait until :date to bid again.",
    "t_free_plan_limit_reached_action"                         => "Upgrade plan",
    ...
    "t_milestone_status_request"                              => "Awaiting deposit",
    "t_milestone_status_funded"                               => "Deposited in escrow",
    "t_milestone_status_paid"                                 => "Released to freelancer",
    "t_milestone_status_cancelled"                            => "Cancelled",
    ...
    "t_follow_up_milestone_only_after_payment"                  => "Follow-up milestones are available only after the original milestone has been paid.",
    "t_follow_up_milestone_default"                             => "Follow-up for milestone \":label\"",
    "t_create_follow_up_milestone"                              => "Create follow-up milestone",
    "t_follow_up_badge"                                         => "Follow-up",
    "t_rate_freelancer"                                         => "Rate freelancer",
    "t_rate_client"                                             => "Rate client",
    "t_rate_freelancer_title"                                   => "How was your collaboration with :name?",
    "t_rate_freelancer_subtitle"                                => "Share a quick score and an optional note to help future clients work confidently.",
    "t_rate_client_title"                                       => "How was working with :name?",
    "t_rate_client_subtitle"                                    => "Leave a quick score and optional insight to guide other freelancers.",
    "t_select_rating_label"                                     => "Select a star rating",
    "t_optional_feedback_label"                                 => "Feedback for them (optional)",
    "t_optional_feedback_placeholder"                           => "Highlight what went well or how the next collaboration could improve.",
    "t_optional_feedback_hint"                                  => "Only the other party and support will see this note if needed.",
    "t_skip_for_now"                                            => "Skip for now",
    "t_rating_submitted_badge"                                  => "Review submitted",
    "t_rating_skipped_badge"                                    => "Review skipped",
    "t_project_review_saved"                                    => "Thank you! Your review has been saved.",
    "t_project_review_skipped"                                  => "No worries—you can leave feedback later if you change your mind.",
    "t_project_rating_required"                                 => "Please choose a rating before submitting your review.",
    "t_project_review_received_subject"                         => "New feedback on \":project\"",
    "t_project_review_received_line"                            => ":username just left you a :rating★ review on \":project\".",
    "t_project_review_received_line_no_rating"                  => ":username shared feedback on \":project\".",
    "t_view_project_feedback"                                   => "View feedback",
    "t_notification_project_review_freelancer"                  => ":username rated you :rating★ on \":project\"",
    "t_notification_project_review_client"                      => ":username rated you :rating★ on \":project\"",
    "t_notification_project_review_confirmation"                => "Your review for :username on \":project\" is live (:rating★).",
    "t_manage_awarded_project"                                  => "Open milestone workspace",
    "t_manage_awarded_project_hint"                             => "Accept the offer, review requirements, and get started from your project workspace.",
    "t_average_bid"                                             => "Average bid",
    "t_project_type"                                            => "Project type",
    "t_days_count"                                              => "{0} No set duration|{1} :count day|[2,*] :count days",
    "t_rating_breakdown_title"                                  => "How did the freelancer perform?",
    "t_rating_breakdown_subtitle"                               => "Score each pillar to capture a sharper picture of the collaboration.",
    "t_rating_breakdown_hint"                                   => "These insights appear on the freelancer’s profile to help future clients understand their strengths.",
    "t_rating_breakdown_card_title"                             => "Detailed review pillars",
    "t_review_aspect_experience"                                => "Freelancer expertise",
    "t_review_aspect_communication"                             => "Communication clarity",
    "t_review_aspect_timeliness"                                => "Timely delivery",
    "t_review_aspect_quality"                                   => "Quality of work",
    "t_review_aspect_professionalism"                           => "Professionalism",
    "t_review_aspect_required"                                  => "Please rate :label (from 1 to 5).",
    "t_freelancers_directory_tagline"                           => "Elite independent talent",
    "t_freelancers_directory_title"                             => "Discover world-class freelancers",
    "t_freelancers_directory_subtitle"                          => "Review verified profiles, compare expertise, and invite top talents from across the Middle East to collaborate on your next project.",
    "t_freelancers_directory_description"                       => "Find and hire trusted experts across design, development, marketing, content, and more on Ta’aquad.",
    "t_freelancers_directory_search_placeholder"                => "Search by name, skill, or speciality…",
    "t_freelancers_directory_metric_profiles"                   => ":count curated profiles ready to work",
    "t_freelancers_directory_metric_average_rating"             => "Top talent averaging 4.9★ from real clients",
    "t_freelancers_directory_metric_countries"                  => "Professionals across :count countries",
    "t_freelancers_directory_filters_heading"                   => "Filter the right expertise",
    "t_freelancers_directory_filters_copy"                      => "Layer filters to instantly surface freelancers who match your brief, budget, and culture.",
    "t_freelancers_directory_clear_filters"                     => "Reset filters",
    "t_freelancers_directory_filter_online"                     => "Show freelancers available now",
    "t_freelancers_directory_filter_rating"                     => "Minimum rating",
    "t_freelancers_directory_filter_country"                    => "Location",
    "t_freelancers_directory_filter_level"                      => "Experience tier",
    "t_freelancers_directory_filter_skills"                     => "Focus skills",
    "t_all_countries"                                           => "All countries",
    "t_all_levels"                                              => "All levels",
    "t_clear"                                                   => "Clear",
    "t_freelancers_sort_relevance"                              => "Best match",
    "t_freelancers_sort_top_rated"                              => "Top rated first",
    "t_freelancers_sort_most_reviewed"                          => "Most reviewed",
    "t_freelancers_sort_recently_active"                        => "Recently active",
    "t_freelancers_sort_newest"                                 => "Newest profiles",
    "t_freelancers_directory_sort_label"                        => "Sort talent",
    "t_freelancers_directory_results_title"                     => ":count specialists ready to collaborate",
    "t_freelancers_directory_results_subtitle"                  => "Shortlist your favourites and invite them to your brief in minutes.",
    "t_updating"                                                => "Updating…",
    "t_reviews_count"                                           => "{0} No reviews yet|{1} :value review|[2,*] :value reviews",
    "t_freelancers_card_reviews"                                => "Client reviews",
    "t_freelancers_card_last_active"                            => "Last active",
    "t_recently_joined"                                         => "Recently joined",
    "t_freelancers_card_profile"                                => "View profile",
    "t_freelancers_card_invite"                                 => "Send offer",
    "t_freelancers_directory_empty_title"                       => "We can’t find a match… yet.",
    "t_freelancers_directory_empty_subtitle"                    => "Adjust your filters or broaden the required skills to discover more brilliant freelancers.",
    "t_freelancers_directory_reset_cta"                         => "Clear filters & start over",
    "t_you_submitted_proposal"                                  => "Proposal submitted",
    "t_send_offer"                                              => "Send offer",
    "t_enable_send_offer"                                       => "Enable send-offer invitations",
    "t_enable_send_offer_hint"                                  => "Allows clients to invite freelancers with private briefs, send attachments, and trigger notifications across the marketplace UI.",
    "t_invite_freelancer_title"                                 => "Invite :name to a private brief",
    "t_invite_freelancer_description"                           => "Send a tailored brief, agree on scope, and collaborate with full protection on Ta’aquad.",
    "t_invite_freelancer_tagline"                               => "Private collaboration",
    "t_invite_freelancer_heading"                               => "Share your brief with :name",
    "t_invite_freelancer_intro"                                 => "Outline the goals, budget, and timeline so your freelancer can respond with clarity. Attach references or supporting documents to accelerate the kickoff.",
    "t_invite_freelancer_brief"                                 => "Project overview",
    "t_invite_freelancer_placeholder"                           => "Describe the outcome you need, deliverables, milestones, and any important notes the freelancer should know…",
    "t_invite_freelancer_budget"                                => "Proposed budget",
    "t_invite_freelancer_timeline"                              => "Estimated delivery time",
    "t_invite_freelancer_attachments"                           => "Supporting files (optional)",
    "t_invite_freelancer_terms"                                 => "By inviting this freelancer you agree to Ta’aquad’s terms and protected payment policies.",
    "t_invite_freelancer_trust_hint"                            => "Funds are only released when both sides approve the delivered work.",
    "t_invite_freelancer_cta"                                   => "Send private invite",
    "t_invite_freelancer_filters_title"                         => "Not sure who fits best?",
    "t_invite_freelancer_point_message"                         => "Add context so the freelancer understands your goals and project constraints.",
    "t_invite_freelancer_point_safety"                          => "Custom offers stay protected under Ta’aquad secure escrow.",
    "t_invite_freelancer_point_response"                        => "Freelancers are notified instantly via email and in-app alerts.",
    "t_bid_requires_portfolio"                                  => "Add at least :count showcase projects to your portfolio before submitting proposals. This helps clients trust your experience.",
    "t_proposal_viewed_subject"                                 => "Your proposal for \":project\" was viewed",
    "t_proposal_viewed_line"                                    => ":username looked at your proposal for \":project\". Keep the conversation moving!",
    "t_view_proposal"                                           => "View proposal",
    "t_notification_proposal_viewed"                            => ":username viewed your proposal for \":project\"",
    ...
    "t_last_review"                                           => "Last review",
    "t_project_brief_questions_heading"                       => "Client questions",
    "t_project_brief_questions_hint"                          => "The client relies on these prompts to gauge your approach, experience, and fit for the project.",
    "t_project_brief_question_required_badge"                 => "Required",
    "t_project_brief_question_optional_badge"                 => "Optional",
    "t_project_requirements_block_subtitle"                   => "Complete every required field to keep your proposal at the top of the review queue.",
    "t_project_brief_question_placeholder"                    => "Share a concise answer that highlights your plan, experience, or clarifying questions.",
    "t_project_required_question_missing"                     => "Please answer this required question.",
    "t_project_nda_heading"                                   => "Non-disclosure agreement",
    "t_project_nda_public_hint"                               => "This project contains sensitive information. Review the confidentiality scope and term before you submit a proposal.",
    "t_project_nda_scope_label"                               => "Protected scope",
    "t_project_nda_scope_default"                             => "All documents, conversations, and assets shared for this engagement.",
    "t_project_nda_term_label"                                => "Confidentiality term",
    "t_project_nda_term_value"                                => "{0} Confidentiality for one month|{1} Confidentiality for one month|[2,*] Confidentiality for :count months",
    "t_project_nda_modal_hint"                                => "Agree to the NDA and add your signature so the client can authorize collaboration instantly.",
    "t_project_nda_checkbox_label"                            => "I agree to keep all project information confidential and use it solely for this engagement.",
    "t_project_nda_signature_label"                           => "Signature",
    "t_project_nda_signature_placeholder"                     => "Type your full legal name",
    "t_project_nda_must_be_confirmed"                         => "Confirm the NDA to continue.",
    "t_project_nda_signature_required"                        => "Enter your full name to sign the NDA.",
    "t_project_nda_signature_length"                          => "Your signature must be at least 3 characters.",
    "t_project_compliance_requirements_missing"               => "Finish the required questions and NDA acknowledgement to continue.",
    "t_freelancer_answers"                                    => "Freelancer responses",
    "t_freelancer_answers_hint"                               => "Use these answers to compare approaches, timelines, and how well they understood your brief.",
    "t_responses"                                             => "responses",
    "t_response_counter"                                      => "Response :count",
    "t_required"                                              => "Required",
    "t_no_answer_provided"                                    => "No answer was provided for this prompt.",
    "t_no_answers_yet"                                        => "This freelancer has not submitted additional responses.",
    "t_nda_status_signed"                                     => "Signed",
    "t_nda_status_pending"                                    => "Awaiting signature",
    "t_download_nda_pdf"                                      => "Download NDA PDF",
    "t_download_nda_locked"                                   => "Available after awarding",
    "t_project_nda_waiting_signature"                         => "Signature pending",
    "t_notification_freelancer_signed_nda"                    => ":username has signed the NDA for “:project”.",
    "t_project_nda_source_document"                           => "Full NDA document",
    "t_project_marked_completed_toast"                        => "Project marked as completed.",
    "t_project_marked_completed_notify"                       => ":username marked “:project” as completed.",
    "t_project_cancelled_toast"                               => "Project cancelled.",
    "t_project_cancelled_notify"                              => ":username cancelled “:project”.",
    "t_project_delivery_request_sent"                         => "Delivery confirmation request sent to the client.",
    "t_project_cancel_request_sent"                           => "Cancellation request sent to the client.",
    "t_project_request_pending_exists"                        => "There's already a pending request awaiting the client's response.",
    "t_project_request_declined"                              => "Request declined.",
    "t_project_request_declined_notify"                       => ":username declined your request for “:project”.",
    "t_project_request_type_deliver"                          => "mark the project as delivered",
    "t_project_request_type_cancel"                           => "cancel the project",
    "t_project_request_client_prompt"                         => ":username would like to :action for “:project”.",
    "t_project_action_invalid_state"                          => "This action isn’t available for the project’s current status.",
    "t_mark_as_completed"                                     => "Mark as completed",
    "t_cancel_project"                                        => "Cancel project",
    "t_confirm_project_completion"                            => "Confirm that all deliverables have been received before completing the project.",
    "t_confirm_project_cancellation"                          => "Canceling will immediately notify the freelancer. You can optionally leave a short note before confirming.",
    "t_project_pending_request_heading"                       => "Review freelancer request",
    "t_project_pending_request_body"                          => ":username asked to :action.",
    "t_approve_request"                                       => "Approve request",
    "t_decline_request"                                       => "Decline",
    "t_optional_note_label"                                   => "Optional note",
    "t_optional_note_placeholder"                             => "Add a short note (optional)",
    "t_project_controls_heading"                              => "Manage project status",
    "t_project_controls_subheading"                           => "Close the project or cancel it at any time. The freelancer will be notified instantly.",
    "t_cancel_note_placeholder"                               => "Share a short note that will be sent to the freelancer (optional).",
    "t_request_waiting_client"                                => "Awaiting client response",
    "t_request_waiting_client_body"                           => "Your request to :action is pending client approval.",
    "t_tracker_activity_review"                               => "Tracked time approval",
    "t_tracker_activity_review_subtitle"                      => "Review and approve the recorded work sessions for “:project”.",
    "t_total_minutes_tracked"                                 => "Total minutes tracked",
    "t_tracker_pending_segments"                              => "Pending segments",
    "t_tracker_approved_segments"                             => "Approved segments",
    "t_tracker_rejected_segments"                             => "Rejected segments",
    "t_minutes"                                               => "min",
    "t_tracked_sessions"                                      => "Tracked sessions",
    "t_tracked_sessions_subtitle"                             => "Review the latest activity submitted by :name and approve or reject as needed.",
    "t_view_screenshot"                                       => "View screenshot",
    "t_low_activity_flag"                                     => "Low activity detected",
    "t_status_pending"                                        => "Pending",
    "t_status_approved"                                       => "Approved",
    "t_status_rejected"                                       => "Rejected",
    "t_time_entry_marked_approved"                            => "The session has been approved successfully.",
    "t_time_entry_marked_rejected"                            => "The session has been rejected.",
    "t_time_entry_not_found_for_screenshot"                   => "We could not find the matching session to attach this screenshot.",
    "t_time_entry_not_found_for_contract"                     => "The requested session could not be found for this contract.",
    "t_contract_not_found_or_inactive"                        => "The selected contract is unavailable or no longer active.",
    "t_end_time_must_be_after_start"                          => "The end time must be after the start time.",
    "t_time_entry_in_future"                                  => "Time entries cannot be scheduled in the future.",
    "t_add_rejection_note_placeholder"                        => "Explain why the session is being rejected (min. 10 characters).",
    "t_submit_decision"                                       => "Submit decision",
    "t_client_note"                                           => "Client note",
    "t_no_tracked_sessions_yet"                               => "No tracked sessions available for review yet.",
    "t_notice"                                                => "Notice",
    "t_unexpected_error_try_again"                            => "An unexpected error occurred. Please try again shortly.",
    "t_tracker_browser_title"                                 => "Tracker Login",
    "t_tracker_browser_heading"                               => "You're signed in to :app",
    "t_tracker_browser_message"                               => "You can now return to the desktop tracker. Keep this window open until the app confirms the login.",
    "t_tracker_browser_signed_in_as"                          => "Signed in as",
    "t_tracker_browser_close_button"                          => "Return to the tracker",
    "t_tracker_browser_logout_button"                         => "Sign in with a different account",
    "t_tracker_browser_manual_hint"                           => "If this window doesn't close automatically, switch back to the tracker app. You may close this tab afterwards.",
];
